...
// addressing the caller used, in one indexed round trip. Org isolation is the
...
// projectScopeResolver adapts the projects Store to cloud.OrgScopeResolver so
...
var _ cloud.OrgScopeResolver = projectScopeResolver{}
