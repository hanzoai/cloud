...
// This file owns the Huly platform MODEL version — the single number the front
...
// the Huly model the front validates against — the transactor hello's
...
// — HULY_MODEL_VERSION exists only to fast-track a front bump ahead of a cloud
// release. It MUST stay 0.6.0 (the front's version-check compares against it).
const defaultModelVersion = "0.6.0"

// modelVersion is the Huly MODEL version string (e.g. "0.6.0"), overridable via
// HULY_MODEL_VERSION.
