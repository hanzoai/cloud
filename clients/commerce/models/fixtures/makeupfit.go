...
var _ = New("makeupfit", func(c *gin.Context) *organization.Organization {
	db := datastore.New(c)
	...
	// Create admins
	u := user.New(db)
	u.Email = "admin@makeupfit.com"
	u.GetOrCreate("Email=", u.Email)
	u.AddOrganization(org.Id())
	u.Put()

	// Configure org
	org.FullName = "makeupfit"
	org.AddOwner(u.Id())
	org.Websites = []website.Website{website.Website{Type: website.Production, Url: "https://makeupfit.com"}}
	org.SecretKey = []byte("42j32ti0DkT3KIMEAD7fseB8CbynO8z9")
