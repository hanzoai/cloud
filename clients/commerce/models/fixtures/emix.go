...
var _ = New("emix", func(c *gin.Context) *organization.Organization {
	db := datastore.New(c)
	...
	u := user.New(db)
	u.Email = "admin@emix.one"
	u.GetOrCreate("Email=", u.Email)
	u.FirstName = "Emix"
	u.LastName = "Admin"
	u.Organizations = []string{org.Id()}
	u.PasswordHash, _ = password.Hash("emixdemo")
	u.Put()

	org.FullName = "Emix Admin"
	org.Owners = []string{u.Id()}
	org.Websites = []website.Website{website.Website{Type: website.Production, Url: "https://emix.one"}}
