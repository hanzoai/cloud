...
// generated per-app clients (plane/<app>, see client/gen) are the ONE typed
...
func Call[In, Out any](ctx context.Context, app, op string, in *In) (*Out, error) {
	Bind()
	...
	if out != nil {
		...
		// is pinned where it is deterministic instead — client.TestAReplyDetachesItself
