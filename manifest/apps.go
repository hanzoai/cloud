...
var Apps = []App{
	...
	{Name: "agent", Pkg: "agents", Prefixes: []string{"/v1/agent"}},
	...
	{Name: "function", Pkg: "functions", Prefixes: []string{"/v1/function"}},
	...
	{Name: "integration", Pkg: "integrations", Prefixes: []string{"/v1/integration"}},
	...
	{Name: "channel", Pkg: "channels", Prefixes: []string{"/v1/channel"}},
	...
	{Name: "audit", Pkg: "auditlog", Prefixes: []string{"/v1/audit"}},
	...
	{Name: "tool", Pkg: "tools", Prefixes: []string{"/v1/tool"}},
