...
var Apps = []App{
	...
	{Name: "deploy", Prefixes: []string{"/v1/deploy/account/can-i", "/v1/deploy/applications", "/v1/deploy/clusters", "/v1/deploy/gitops", "/v1/deploy/health", "/v1/deploy/projects", "/v1/deploy/reconcile", "/v1/deploy/session/userinfo", "/v1/deploy/settings", "/v1/deploy/stream/applications", "/v1/deploy/version"}},
	...
	{Name: "catalogsync", Prefixes: []string{"/v1/catalogsync"}},
	...
	{Name: "team", Prefixes: []string{"/account", "/billing/plan", "/billing/ui", "/bots", "/collaborator", "/files/:workspace", "/v1/team"}},
