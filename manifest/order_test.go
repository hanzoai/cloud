...
var frozen = []string{
	"pubsub", "kafka", "amqp", "mq", "skills", "flags", "kms", "metrics",
	...
	"dns", "domain", "prompts", "agents", "links", "wallets",
	"x402", "deploy", "functions", "todo", "templates", "blueprint",
	"framework", "knowledge", "graph", "help", "content", "catalogsync", "webhooks",
	"ml", "label", "reference", "risk", "datasets", "usage", "leaderboard", "crm", "marketing", "ads",
	"campaigns", "validators", "social", "event", "git", "sync",
	"visor", "captable", "code", "lsp", "networks", "share",
	...
	"index", "catalog", "taxonomy", "world", "web3", "bots", "authors",
