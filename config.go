...
func LoadConfig() *Config {
	cfg := &Config{
		...
		// Billing gate. Token comes from a KMS-backed secret the operator
		// wires as COMMERCE_SERVICE_TOKEN (env name shared with every other
		// Hanzo product per metering's convention) — never plaintext here.
