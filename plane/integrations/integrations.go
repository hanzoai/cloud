...
// That last one is not a style preference: integrations's own callers used to reach it
...
//
// It depends on the CONTRACT (package plane) and never on integrations's implementation,
