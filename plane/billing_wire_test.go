...
var billingWire = []any{
	...
	// credits
	plane.SubjectIn{}, plane.CreditGrants{}, plane.CreditGrant{},
	plane.CreditBalance{}, plane.CreditEntry{},
	plane.CreditBreakdown{}, plane.CreditTag{}, plane.CreditTotal{},
	// caps
	plane.Alerts{}, plane.Alert{}, plane.AlertSpec{}, plane.AlertPatch{},
	plane.AlertRef{}, plane.Dropped{}, plane.CapIn{}, plane.CapVerdict{},
	// rails
	plane.CryptoOptions{}, plane.CryptoMintIn{}, plane.CryptoDepositIn{},
	plane.CryptoDeposit{}, plane.WireIn{}, plane.WireInstructions{},
	// tier and rollup
	plane.Tier{}, plane.TierLimits{}, plane.TierBalance{}, plane.Window{},
	plane.RollupIn{}, plane.Rollup{}, plane.RollupAllotment{}, plane.RollupBalance{},
	// posture, methods, plans, subscriptions
	plane.PaymentConfig{}, plane.ModeIn{}, plane.Mode{},
	plane.Rendered{}, plane.MethodsIn{}, plane.MethodSaveIn{},
	plane.MethodRef{}, plane.Detachment{}, plane.PlansIn{},
	plane.SubscriptionRef{},
}
