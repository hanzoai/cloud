...
require (
	...
	github.com/hanzoai/commerce v1.50.84
	...
	github.com/hanzoai/iam v1.34.97
...
require (
	...
	github.com/hanzoai/agent v1.0.7
	github.com/hanzoai/ai v1.833.215
...
require (
	...
	github.com/hanzoai/framework v0.1.3
...
require github.com/hanzoai/s3 v1.0.24-0.20260830195337-15d06b66bd3b
...
// supplying one import path is ambiguous and fails the load, so the submodule
