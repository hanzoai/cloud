...
// ErrNoMembership is returned by a Leases when the live replica set is empty: no
...
// ownerView is the slice of Membership the Leases needs: this replica's id and the
...
// CASFencer implements ha.Leases by claiming/renewing a per-org writer lease in a
