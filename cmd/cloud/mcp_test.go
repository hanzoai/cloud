...
//
// The MCP server is the HOST's, registered by client.Use, and zip's is disabled — the
...
// tested against running subsystems in client/mcp_test.go.
func app308(t *testing.T) *zip.App {
	...
	client.Use(app, manifest.MCPPath, nil, func(string) (string, string, error) {
