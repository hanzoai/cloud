...
// own binary emits from its own live router — the same input gen-client-catalog
...
// of reason (gen-client-catalog: the audience is a fleet fact an app cannot see).
//
