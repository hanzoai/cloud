...
// own binary emits from its own live router — the same input gen-surface-catalog
// reads, and the same subsets the compose holds against the composed document. So a skill
...
// of reason (gen-surface-catalog: the audience is a fleet fact an app cannot see).
//
