...
interface channel {
    ...
    get_channel() returns (rep: chatChannels)
    ...
    get_channel_inbox(req: inboxIn) returns (rep: inboxPage)
    ...
    get_channel_pairing() returns (rep: pairingQueue)
    ...
    post_channel_pairing_approve(req: approvePairingIn) returns (rep: pairingApproved)
}
...
#   get_channel_agent  channelAgents.Rooms  map[string]string  (map)
#   get_channel_allowlist  allowlistView.AccessGroups  map[string]map[string][]string  (map)
#   put_channel_agent  channelAgents  channels.channelAgents  (reaches one)
#   put_channel_agent  channelAgentsPut.Rooms  map[string]string  (map)
#   put_channel_allowlist  allowlistPutIn.AccessGroups  map[string]map[string][]string  (map)
#   put_channel_allowlist  allowlistView  channels.allowlistView  (reaches one)
#
