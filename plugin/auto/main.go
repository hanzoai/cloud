...
// Standalone entry for the auto app.
//
// This is the app's OWN composition root — it links only apps/auto and the
...
// serves standalone. Its OpenAPI subset comes from `auto openapi`.
//
