...
#   get_projects_by_slug  projectsProject.Tags  map[string]string  (map)
#   get_projects_by_slug_deployments_by_id  projectsDeployment.Upload  projects.projectsUploadGrant  (reaches one)
#   get_projects_edge  edgeState.Policy  map[string]string  (map)
#   patch_projects_by_slug  projectsProject  projects.projectsProject  (reaches one)
#   patch_projects_by_slug  projectsUpdate.Tags  map[string]string  (map)
