...
import (
	...
	"github.com/hanzoai/cloud/apps/datasets"
)
...
//
// It does not own health. Serve's generic /v1/datasets/health liveness route is
...
func main() {
	if err := cloud.Listen([]cloud.Plugin{{
		Name:  "datasets",
		Price: cloud.Metered,
		Mount: datasets.Mount,
	}}, []string{"datasets"}); err != nil {
