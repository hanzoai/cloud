...
\\multicolumn{11}{l}{Na\\\"ive Brain, \\texttt{usenaive.ai/lab/memory} (read 2026-09-15, dated July 2026), pooled: 91 / 57 on a matched gpt-4o-mini backbone} \\\\
\\multicolumn{11}{l}{\\quad that page names no dataset; it is identified as this one by its baselines, which are CAR's to the decimal --- 78.0/30.2, 54, 28, 18, 7} \\\\\n\\bottomrule\n\\end{tabular}\n`, 'runs/mab-*; substring exact match; 6k is the dev split, the rest test; pooled = mean of the four sizes as CAR reports')
}
