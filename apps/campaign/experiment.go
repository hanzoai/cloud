...
// experiment.Assign (the root supplies the project and extracts the variant key
...
// experiment.Analyze (pull-model: it reads the metric from analytics itself). The
