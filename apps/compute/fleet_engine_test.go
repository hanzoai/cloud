...
// /v1/compute/fleet/workers. These structs are mirrors — the test guards the round-trip so
...
func TestByoWorkerEmitsEngine(t *testing.T) {
	...
	// GET /v1/compute/fleet/workers must expose the endpoint so the gateway/CLI can route.
