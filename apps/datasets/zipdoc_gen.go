...
func init() {
	zip.Describe("DELETE /v1/datasets/:name", zip.Doc{
	...
	zip.Describe("GET /v1/datasets", zip.Doc{
	...
	zip.Describe("GET /v1/datasets/:name", zip.Doc{
	...
	zip.Describe("GET /v1/datasets/:name/export", zip.Doc{
	...
	zip.Describe("GET /v1/datasets/:name/lineage", zip.Doc{
	...
	zip.Describe("POST /v1/datasets", zip.Doc{
	...
	zip.Describe("POST /v1/datasets/:name/materialize", zip.Doc{
