...
// newApp mounts the auto subsystem on a fresh zip.App with a temp DataDir,
...
// catalogue `auto describe` serialises and the host composes onto the
// fleet's one MCP server; a connector ACTION is a different value, published into
