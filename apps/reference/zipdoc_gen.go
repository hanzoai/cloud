...
func init() {
	zip.Describe("DELETE /v1/ml/reference/:set", zip.Doc{
	...
	zip.Describe("GET /v1/ml/reference", zip.Doc{
		...
		Fields: map[string]string{
			...
			"ReferenceSource.terms":    "Terms is the licence or permission this data is redistributed under. A\nsource with no stated terms is not in the catalog.",
	...
	zip.Describe("GET /v1/ml/reference/:set", zip.Doc{
	...
	zip.Describe("POST /v1/ml/reference/refresh", zip.Doc{
	...
	zip.Describe("POST /v1/ml/reference/resolve", zip.Doc{
	...
	zip.Describe("PUT /v1/ml/reference/:set", zip.Doc{
