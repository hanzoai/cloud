...
func routes(app cloud.Router, zapp *zip.App, s *cloud.Service[state]) {
	...
	// Every op below is declared on the App with its FULL path too, never on the
	...
	// up — the comments would be written, generated, and silently never rendered.
	//
	...
	zip.Get(zapp, "/v1/company/register", o.registerList)
	zip.Get(zapp, "/v1/company/register/summary", o.registerSummary)
	zip.Get(zapp, "/v1/company/review", o.registerReview)
	zip.Put(zapp, "/v1/company/structure", o.setStructure)
	zip.Post(zapp, "/v1/company/founders", o.setFounders)
	zip.Post(zapp, "/v1/company/kyc", o.startKYC)
	zip.Post(zapp, "/v1/company/kyc/refresh", o.kycRefresh)
	zip.Post(zapp, "/v1/company/kyc/decision", o.kycDecision)
	...
	zip.Post(zapp, "/v1/company/documents", o.generateDocuments)
	zip.Post(zapp, "/v1/company/esign", o.requestEsign)
	zip.Post(zapp, "/v1/company/esign/complete", o.completeEsign)
	zip.Post(zapp, "/v1/company/genesis", o.recordGenesis)
	zip.Post(zapp, "/v1/company/advance", o.advance)
	zip.Post(zapp, "/v1/company/skip", o.skip)
	zip.Post(zapp, "/v1/company/import/documents", o.importDocuments)
	zip.Post(zapp, "/v1/company/import/captable", o.importCapTable)
	zip.Post(zapp, "/v1/company/fundraise/round", o.fundraiseRound, zip.WithStatus(http.StatusCreated))
	zip.Post(zapp, "/v1/company/fundraise/safe", o.fundraiseSafe, zip.WithStatus(http.StatusCreated))
}
...
// Get returns the caller org's formation and the stages reachable from it.
// An org that has not begun a formation is not found.
...
// RequestSafe raises an e-signature request over documents already in the data room.
// A SAFE, a convertible note or any other fundraising paper qualifies; it is
