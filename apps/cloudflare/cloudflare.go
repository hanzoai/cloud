...
func Mount(app cloud.Router, deps cloud.Deps) error {
	// A Router that cannot reach the typed-op registry would serve routes no
	// projection knows, so the mount fails rather than half-publishing this plane.
	if app != nil && cloud.ZipApp(app) == nil {
		return fmt.Errorf("cloudflare.Mount: router carries no typed-op registry")
	}
...
//
// Ops are declared on the REGISTRY with the WHOLE path spelled, because that path
// is the operation's identity in every projection (document, MCP tool, CLI command,
// SDK method) AND the key cmd/zipdoc writes its prose under. A group-relative
// registration composes the prefix for the router but not for the extractor, so the
// two disagree and the prose reaches nothing.
//
...
// Those six stay on the group, whose prefix the router composes for them.
func routes(app cloud.Router, s *cloud.Service[state]) {
	g := app.Group("/v1/cloudflare")
	o := ops{s: s}
	// z is the typed-op registry every projection reads. Mount refuses a Router
	// that cannot reach it, so it is non-nil here.
	z := cloud.ZipApp(app)
	...
	zip.Get(z, "/v1/cloudflare/zones", o.zonesList)
	zip.Get(z, "/v1/cloudflare/zones/:zone", o.zoneGet)
	zip.Get(z, "/v1/cloudflare/zones/:zone/analytics", o.zoneAnalytics)
	zip.Post(z, "/v1/cloudflare/zones/:zone/purge", o.zonePurge)

	// Pages — account-scoped.
	zip.Get(z, "/v1/cloudflare/pages/projects", o.pagesList)
	zip.Post(z, "/v1/cloudflare/pages/projects", o.pagesCreate)
	zip.Get(z, "/v1/cloudflare/pages/projects/:project", o.pagesGet)
	zip.Delete(z, "/v1/cloudflare/pages/projects/:project", o.pagesDelete)
	...
	zip.Post(z, "/v1/cloudflare/pages/projects/:project/domains", o.pagesDomainAdd)
	zip.Delete(z, "/v1/cloudflare/pages/projects/:project/domains/:domain", o.pagesDomainDelete)

	// Workers — scripts + workers.dev subdomain are account-scoped; routes are
	// zone-scoped.
	zip.Get(z, "/v1/cloudflare/workers/scripts", o.workersScriptList)
	...
	zip.Delete(z, "/v1/cloudflare/workers/scripts/:script", o.workersScriptDelete)
	zip.Post(z, "/v1/cloudflare/workers/scripts/:script/subdomain", o.workersScriptSubdomainSet)
	zip.Get(z, "/v1/cloudflare/workers/subdomain", o.workersSubdomainGet)
	zip.Get(z, "/v1/cloudflare/workers/zones/:zone/routes", o.workersRouteList)
	zip.Post(z, "/v1/cloudflare/workers/zones/:zone/routes", o.workersRouteCreate)
	zip.Delete(z, "/v1/cloudflare/workers/zones/:zone/routes/:route", o.workersRouteDelete)
	...
	zip.Get(z, "/v1/cloudflare/r2/buckets", o.r2BucketList)
	zip.Post(z, "/v1/cloudflare/r2/buckets", o.r2BucketCreate)
	zip.Delete(z, "/v1/cloudflare/r2/buckets/:bucket", o.r2BucketDelete)

	// KV — namespaces and a namespace's key values.
	zip.Get(z, "/v1/cloudflare/kv/namespaces", o.kvNamespaceList)
	zip.Post(z, "/v1/cloudflare/kv/namespaces", o.kvNamespaceCreate)
	zip.Delete(z, "/v1/cloudflare/kv/namespaces/:namespace", o.kvNamespaceDelete)
	...
	zip.Delete(z, "/v1/cloudflare/kv/namespaces/:namespace/values/:key", o.kvValueDelete)

	// D1 — databases and a query against one.
	zip.Get(z, "/v1/cloudflare/d1/databases", o.d1DatabaseList)
	zip.Post(z, "/v1/cloudflare/d1/databases", o.d1DatabaseCreate)
	zip.Delete(z, "/v1/cloudflare/d1/databases/:database", o.d1DatabaseDelete)
