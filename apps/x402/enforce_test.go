...
//
// The tool path is deliberately the other way round (see Settle): it offers EVERY
// dispatch to the seam, free ones included, so a missing table there means "nothing
// is priced" and free tools must keep working. Two different questions, two
// different safe answers — which is why the distinction is stated in code rather
// than left to a shared default.
