...
func init() {
	...
	zip.Describe("GET /v1/ml/learning", zip.Doc{
		...
		Fields: map[string]string{
			...
			"mlLearningCurve.superseded": "Superseded is how many mature judged decisions were scored under a\ndifferent scoring shape and therefore appear at no step.",
			"mlLearningCurve.truncated":  "Truncated says the bounded read cut the history at its oldest end.",
	...
	zip.Describe("POST /v1/ml/evaluate", zip.Doc{
		...
		Fields: map[string]string{
			...
			"mlMeasurement.refusal":    "Refusal names why there was no probability, when there was none.",
			"mlMeasurement.stage":      "Stage is whose bands supplied the operating point and the prices, when one\ndid.",
			"mlMeasurement.superseded": "Superseded is how many mature judged decisions were scored under a\ndifferent scoring shape and therefore measured nowhere here.",
			"mlMeasurement.truncated":  "Truncated says the bounded read cut the history at its oldest end.",
