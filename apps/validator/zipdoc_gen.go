...
func init() {
	zip.Describe("GET /v1/validator", zip.Doc{
	...
	zip.Describe("GET /v1/validator/:tokenId", zip.Doc{
	...
	zip.Describe("GET /v1/validator/challenge", zip.Doc{
	...
	zip.Describe("POST /v1/validator", zip.Doc{
