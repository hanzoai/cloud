...
func init() {
	zip.Describe("github.com/hanzoai/cloud/apps/validator GET /v1/validator", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/cloud/apps/validator GET /v1/validator/:tokenId", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/cloud/apps/validator GET /v1/validator/challenge", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/cloud/apps/validator POST /v1/validator", zip.Doc{
		...
		Fields: map[string]string{
			...
			"slotView.updatedAt":       "UpdatedAt is when the slot last changed, as a Unix timestamp.",
			"slotView.wallet":          "Wallet is the lowercase Ethereum address that proved ownership of the NFT.",
			"validatorClaim.nonce":     "Nonce is the value GET /v1/validator/challenge issued for this slot.",
