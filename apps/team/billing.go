...
func (b *billingService) register(app cloud.Router, zapp *zip.App, guard guardFn) {
	...
	// does not exist.
	zip.Get(zapp, teamPrefix+"/billing/plan", b.readPlan)
...
// ReadPlan returns the plan and seat counts for the caller's OWN org.
