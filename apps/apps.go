...
func Wire() []cloud.MountSpec {
	return []cloud.MountSpec{
		...
		{Name: "metrics", Price: cloud.Free, App: cloud.MountMetrics},
		...
		cloud.PluginSpec("o11y", cloud.Free, where("o11y"), "/v1/o11y", "/v1/sentry"),
		{Name: "authz", Price: cloud.Free, App: authz.Mount},
		...
		{Name: "commerce", Price: cloud.Free, App: commerce.Mount},
		{Name: "licensing", Price: cloud.Free, App: licensing.Mount},
		...
		{Name: "platform", Price: cloud.Metered, Mount: platform.Mount, Shutdown: cloud.CtxShutdown(platform.Shutdown), OwnsHealth: true},
		{Name: "projects", Price: cloud.Metered, Mount: projects.Mount, Shutdown: cloud.CtxShutdown(projects.Shutdown)},
		...
		{Name: "wallets", Price: cloud.Free, Mount: wallets.Mount, Shutdown: cloud.CtxShutdown(wallets.Shutdown)},
		...
		{Name: "framework", Price: cloud.Free, Mount: framework.Mount, Shutdown: cloud.CtxShutdown(framework.Shutdown)},
		...
		{Name: "content", Price: cloud.Metered, Mount: content.Mount, Shutdown: cloud.CtxShutdown(content.Shutdown)},
		...
		{Name: "marketing", Price: cloud.Free, Mount: marketing.Mount, Shutdown: cloud.CtxShutdown(marketing.Shutdown)},
		...
		{Name: "ads", Price: cloud.Free, Mount: ads.Mount, Shutdown: cloud.CtxShutdown(ads.Shutdown)},
		...
		{Name: "campaign", Price: cloud.Free, Mount: campaign.Mount, Shutdown: cloud.CtxShutdown(campaign.Shutdown)},
		...
		{Name: "validators", Price: cloud.Free, Mount: validators.Mount, Shutdown: cloud.CtxShutdown(validators.Shutdown)},
		...
		{Name: "social", Price: cloud.Free, Mount: social.Mount, Shutdown: cloud.CtxShutdown(social.Shutdown)},
		...
		{Name: "sync", Price: cloud.Free, Mount: sync.Mount, Shutdown: cloud.CtxShutdown(sync.Shutdown)},
		...
		{Name: "security", Price: cloud.Metered, Mount: security.Mount, Shutdown: cloud.CtxShutdown(security.Shutdown), OwnsHealth: true},
		...
		{Name: "destinations", Price: cloud.Free, Mount: destinations.Mount, Shutdown: cloud.CtxShutdown(destinations.Shutdown)},
		...
		{Name: "team", Price: cloud.Free, Mount: team.Mount, Shutdown: cloud.CtxShutdown(team.Shutdown)},
		...
		{Name: "index", Price: cloud.Free, Mount: index.Mount, Shutdown: cloud.CtxShutdown(index.Shutdown), OwnsHealth: true},
		...
		{Name: "world", Price: cloud.Free, Mount: world.Mount, Shutdown: cloud.CtxShutdown(world.Shutdown)},
		...
		{Name: "authors", Price: cloud.Free, Mount: authors.Mount, Shutdown: cloud.CtxShutdown(authors.Shutdown)},
		...
		{Name: "research", Price: cloud.Free, Mount: research.Mount, Shutdown: cloud.CtxShutdown(research.Shutdown)},
		...
		{Name: "experiments", Price: cloud.Free, Mount: experiments.Mount, Shutdown: cloud.CtxShutdown(experiments.Shutdown)},
		...
		{Name: "books", Price: cloud.Free, Mount: books.Mount, Shutdown: cloud.CtxShutdown(books.Shutdown)},
		{Name: "treasury", Price: cloud.Free, Mount: treasury.Mount, Shutdown: cloud.CtxShutdown(treasury.Shutdown)},
		...
		{Name: "admission", Price: cloud.Free, Mount: admission.Mount, Shutdown: cloud.CtxShutdown(admission.Shutdown)},
		...
		{Name: "guide", Price: cloud.Free, Mount: guide.Mount, Shutdown: cloud.CtxShutdown(guide.Shutdown)},
		...
		{Name: "compliance", Price: cloud.Free, Mount: compliance.Mount, Shutdown: cloud.CtxShutdown(compliance.Shutdown), OwnsHealth: true},
		{Name: "legal", Price: cloud.Free, Mount: legal.Mount, Shutdown: cloud.CtxShutdown(legal.Shutdown), OwnsHealth: true},
		...
		{Name: "agent", Price: cloud.Metered, App: agent.Mount},
		...
		{Name: "translate", Price: cloud.Metered, Mount: translate.Mount, Shutdown: cloud.CtxShutdown(translate.Shutdown)},
		...
		{Name: "zen", Price: cloud.Metered, Mount: zen.Mount, Prefixes: []string{"/v1"}},
		{Name: "ai", Price: cloud.Metered, App: ai.Mount},
...
// failure looks like an empty dashboard instead of an error. o11y is the
// standing example — its OTLP collector must be accepting spans before anything
// has one to send. Everything absent from this map is lazy, which is what makes
// a 69-service binary cheap: an app nobody calls costs a route entry and a
// struct, not a process.
var eager = map[string]bool{
