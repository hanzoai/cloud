...
// /v1/event/insights — the UNIFIED native insights surface on the SAME engine.
//
...
//
//	GET  /v1/event/insights/events  recent events for the org (console read; limit<=200)
//	GET  /v1/event/insights/health  liveness of the unified surface
//
