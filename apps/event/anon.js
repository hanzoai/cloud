 ...
 *   2. hanzoai/cloud apps/analytics/tag.js — the tag the host serves at
 *      /v1/event/tag.js; vendors this file and its tag.go serves the marked region
 *      with the tag as one asset, so the host holds no second copy either.
 *
 ...
 * against the vendored copy. After editing, resync the host:
 *
