...
- `GET https://api.lux.network/v1/commerce/submission/` — List your org's submissions, as a page
- `GET https://api.lux.network/v1/commerce/submission/{submissionid}` — Fetch one submission
...
- `/v1/commerce/submission/` → JSON object.
- `/v1/commerce/submission/{submissionid}` → JSON object.

## Example

```bash
curl -sS "https://api.lux.network/v1/commerce/submission/" \
