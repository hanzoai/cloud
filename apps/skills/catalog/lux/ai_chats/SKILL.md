...
- `GET https://api.lux.network/v1/ai/chats` — List chats
- `GET https://api.lux.network/v1/ai/chats/global` — List chats across tenants
- `GET https://api.lux.network/v1/ai/chats/{owner}/{name}` — Retrieve a chat
...
```bash
curl -sS "https://api.lux.network/v1/ai/chats" \
