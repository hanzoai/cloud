...
- `GET https://api.lux.network/v1/o11y/query_range` — Runs a Prometheus-style range query over metrics — the legacy read that predates the v5 querier — and returns the matrix, vector or scalar the query resolved to.
...
```bash
curl -sS "https://api.lux.network/v1/o11y/query_range" \
