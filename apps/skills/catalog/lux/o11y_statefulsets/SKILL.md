---
name: o11y_statefulsets
version: "8.0.0"
description: "Read o11y statefulsets: Lists the metric attribute keys Kubernetes statefulsets report, for building statefulset filters., Lists the values one statefulset attribute key has taken, for building statefulset filters.."
---

# Lux · O11Y · statefulsets
...
- `GET https://api.lux.network/v1/o11y/statefulsets/attribute_keys` — Lists the metric attribute keys Kubernetes statefulsets report, for building statefulset filters.
- `GET https://api.lux.network/v1/o11y/statefulsets/attribute_values` — Lists the values one statefulset attribute key has taken, for building statefulset filters.
...
- `/v1/o11y/statefulsets/attribute_keys` → `o11y.O11yInfraAttributeKeysOut` object with fields: `data`, `status`.
- `/v1/o11y/statefulsets/attribute_values` → `o11y.O11yInfraAttributeValuesOut` object with fields: `data`, `status`.

## Example

```bash
curl -sS "https://api.lux.network/v1/o11y/statefulsets/attribute_keys" \
