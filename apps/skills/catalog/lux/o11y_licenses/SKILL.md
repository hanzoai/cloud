...
name: o11y_licenses
version: "8.0.0"
description: "Read o11y licenses: Lists the org's licenses., Activates the enterprise license.."
---
...
- `GET https://api.lux.network/v1/o11y/licenses` — Lists the org's licenses.
- `GET https://api.lux.network/v1/o11y/licenses/active` — Activates the enterprise license.

## Response

- `/v1/o11y/licenses` → `o11y.O11yLicensesOut` object with fields: `data`, `status`.
- `/v1/o11y/licenses/active` → `o11y.O11yLicenseActiveOut` object with fields: `data`, `status`.

## Example

```bash
curl -sS "https://api.lux.network/v1/o11y/licenses" \
