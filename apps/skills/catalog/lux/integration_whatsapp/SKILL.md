...
- `GET https://api.lux.network/v1/integration/whatsapp/webhook` — WhatsApp Cloud API subscription challenge
...
```bash
curl -sS "https://api.lux.network/v1/integration/whatsapp/webhook" \
