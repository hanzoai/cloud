...
- `GET https://api.lux.network/v1/tel/numbers` — Lists the phone numbers this org HOLDS — the ones it has bought and not released.
- `GET https://api.lux.network/v1/tel/numbers/available` — Asks the carrier what is available to buy.
...
```bash
curl -sS "https://api.lux.network/v1/tel/numbers" \
