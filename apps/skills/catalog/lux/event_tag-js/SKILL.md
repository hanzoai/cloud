...
name: event_tag-js
version: "8.0.0"
description: "Read event tag js: The Lux event tag — the one-line install for a surface with no bundler."
---
...
- `GET https://api.lux.network/v1/event/tag.js` — The Lux event tag — the one-line install for a surface with no bundler
...
```bash
curl -sS "https://api.lux.network/v1/event/tag.js" \
