...
name: o11y_features
version: "8.0.0"
description: "Read o11y features: Returns the supported feature flags and their resolved values for the caller's org.."
---
...
- `GET https://api.lux.network/v1/o11y/features` — Returns the supported feature flags and their resolved values for the caller's org.

## Response

- `/v1/o11y/features` → `o11y.O11yFeaturesOut` object with fields: `data`, `status`.

## Example

```bash
curl -sS "https://api.lux.network/v1/o11y/features" \
