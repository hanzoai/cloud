...
version: "8.0.0"
description: "Read pricing summary: Returns the catalog's headline statistics — model counts by family and the provider directory.."
---
...
- `GET https://api.lux.network/v1/pricing/summary` — Returns the catalog's headline statistics — model counts by family and the provider directory.

## Response

- `/v1/pricing/summary` → JSON object.

## Example

```bash
curl -sS "https://api.lux.network/v1/pricing/summary" \
