...
- `GET https://api.lux.network/v1/ai/tasks` — List tasks
- `GET https://api.lux.network/v1/ai/tasks/global` — List tasks across tenants
- `GET https://api.lux.network/v1/ai/tasks/{owner}/{name}` — Retrieve a task
...
```bash
curl -sS "https://api.lux.network/v1/ai/tasks" \
