...
- `GET https://api.lux.network/v1/ai/workflows` — List workflows
- `GET https://api.lux.network/v1/ai/workflows/global` — List workflows across tenants
- `GET https://api.lux.network/v1/ai/workflows/{owner}/{name}` — Retrieve a workflow
...
```bash
curl -sS "https://api.lux.network/v1/ai/workflows" \
