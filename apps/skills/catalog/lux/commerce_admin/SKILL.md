...
- `GET https://api.lux.network/v1/commerce/admin/catalog` — The catalog projection with cost and margin included
...
```bash
curl -sS "https://api.lux.network/v1/commerce/admin/catalog" \
