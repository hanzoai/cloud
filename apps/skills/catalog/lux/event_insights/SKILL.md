...
- `GET https://api.lux.network/v1/event/insights/events` — Returns the caller org's most recent product events, newest first.
- `GET https://api.lux.network/v1/event/insights/health` — Reports that the unified insights surface is serving.
...
```bash
curl -sS "https://api.lux.network/v1/event/insights/events" \
