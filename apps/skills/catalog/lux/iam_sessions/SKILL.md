...
- `GET https://api.lux.network/v1/iam/sessions` — Returns who is currently signed in to an organization, newest first, and can be narrowed to one person or one application.
