...
- `GET https://api.lux.network/v1/iam/applications/get` — Returns one application: its sign-in methods, its allowed redirect URIs and the client credentials your integration authenticates with.
