...
name: ai_system
version: "8.0.0"
description: "Read ai system: System."
---
...
- `GET https://api.lux.network/v1/ai/system` — System

## Response

- `/v1/ai/system` → `Envelope` object with fields: `data`, `data2`, `msg`, `status`.

## Example

```bash
curl -sS "https://api.lux.network/v1/ai/system" \
