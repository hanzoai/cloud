...
name: ai_videos
version: "8.0.0"
description: "Read ai videos: List videos, List videos across tenants, Retrieve a video."
---
...
- `GET https://api.lux.network/v1/ai/videos` — List videos
- `GET https://api.lux.network/v1/ai/videos/global` — List videos across tenants
- `GET https://api.lux.network/v1/ai/videos/{owner}/{name}` — Retrieve a video
...
- `/v1/ai/videos` → JSON object.
- `/v1/ai/videos/global` → JSON object.
- `/v1/ai/videos/{owner}/{name}` → JSON object.

## Example

```bash
curl -sS "https://api.lux.network/v1/ai/videos" \
