...
- `GET https://api.lux.network/v1/functions/secrets` — The names of the secrets mounted by the caller's org's functions
...
```bash
curl -sS "https://api.lux.network/v1/functions/secrets" \
