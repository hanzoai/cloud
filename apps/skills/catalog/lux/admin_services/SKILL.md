...
- `GET https://api.lux.network/v1/admin/services` — Reads the launch board: every hosted service in the registry with its LIVE waitlist mode, evaluated through the flag engine.
...
```bash
curl -sS "https://api.lux.network/v1/admin/services" \
