...
name: ai_dashboards
version: "8.0.0"
description: "Read ai dashboards: Dashboards Agents, Dashboards Vm."
---
...
- `GET https://api.lux.network/v1/ai/dashboards/agents` — Dashboards Agents
- `GET https://api.lux.network/v1/ai/dashboards/vm` — Dashboards Vm
...
```bash
curl -sS "https://api.lux.network/v1/ai/dashboards/agents" \
