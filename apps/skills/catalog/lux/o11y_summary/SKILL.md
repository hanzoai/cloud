...
name: o11y_summary
version: "8.0.0"
description: "Read o11y summary: Reports whether the platform is up.."
---
...
- `GET https://api.lux.network/v1/o11y/summary` — Reports whether the platform is up.

## Response

- `/v1/o11y/summary` → `o11y.StatusSummary` object with fields: `checked_at`, `in_progress_maintenances`, `ongoing_incidents`, `page_title`, `page_url`, `scheduled_maintenances`.

## Example

```bash
curl -sS "https://api.lux.network/v1/o11y/summary" \
