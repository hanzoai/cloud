...
name: iam_consent
version: "8.0.0"
description: "Read iam consent: Returns the calling person's own privacy and communication choices.."
---
...
- `GET https://api.lux.network/v1/iam/consent` — Returns the calling person's own privacy and communication choices.

## Response

- `/v1/iam/consent` → JSON object.

## Example

```bash
curl -sS "https://api.lux.network/v1/iam/consent" \
