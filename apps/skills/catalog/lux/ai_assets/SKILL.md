...
name: ai_assets
version: "8.0.0"
description: "Read ai assets: List assets, Retrieve a asset."
---
...
- `GET https://api.lux.network/v1/ai/assets` — List assets
- `GET https://api.lux.network/v1/ai/assets/{owner}/{name}` — Retrieve a asset
...
- `/v1/ai/assets` → JSON object.
- `/v1/ai/assets/{owner}/{name}` → JSON object.

## Example

```bash
curl -sS "https://api.lux.network/v1/ai/assets" \
