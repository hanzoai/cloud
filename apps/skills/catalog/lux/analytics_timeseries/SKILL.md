...
- `GET https://api.lux.network/v1/analytics/timeseries` — Timeseries returns the caller org's LLM usage over time as an evenly-spaced series.
...
```bash
curl -sS "https://api.lux.network/v1/analytics/timeseries" \
