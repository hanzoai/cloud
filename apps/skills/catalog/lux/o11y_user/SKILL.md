...
- `GET https://api.lux.network/v1/o11y/user` — Lists the org's members with their single legacy role.
- `GET https://api.lux.network/v1/o11y/user/me` — Returns the calling user with their single legacy role.
- `GET https://api.lux.network/v1/o11y/user/preferences` — Lists every preference of the calling user, each with its current and default value.
- `GET https://api.lux.network/v1/o11y/user/preferences/{name}` — Returns one preference of the calling user, by name.
- `GET https://api.lux.network/v1/o11y/user/{id}` — Returns one org member with their single legacy role, by user id.
...
```bash
curl -sS "https://api.lux.network/v1/o11y/user" \
