...
- `GET https://api.lux.network/v1/sandbox/{id}/terminal` — The terminal, as a page
- `GET https://api.lux.network/v1/sandbox/{id}/terminal/ws` — The terminal, as a socket
...
```bash
curl -sS "https://api.lux.network/v1/sandbox/{id}/terminal" \
