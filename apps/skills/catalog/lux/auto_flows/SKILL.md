...
- `GET https://api.lux.network/v1/auto/flows` — Flows lists the caller's flows, newest first.
- `GET https://api.lux.network/v1/auto/flows/{flow}` — Flow reads one of the caller's flows — the full record, graph included.
