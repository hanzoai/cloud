...
name: o11y_nodes
version: "8.0.0"
description: "Read o11y nodes: Lists the metric attribute keys Kubernetes nodes report, for building node filters., Lists the values one node attribute key has taken, for building node filters.."
---
...
- `GET https://api.lux.network/v1/o11y/nodes/attribute_keys` — Lists the metric attribute keys Kubernetes nodes report, for building node filters.
- `GET https://api.lux.network/v1/o11y/nodes/attribute_values` — Lists the values one node attribute key has taken, for building node filters.
...
- `/v1/o11y/nodes/attribute_keys` → `o11y.O11yInfraAttributeKeysOut` object with fields: `data`, `status`.
- `/v1/o11y/nodes/attribute_values` → `o11y.O11yInfraAttributeValuesOut` object with fields: `data`, `status`.

## Example

```bash
curl -sS "https://api.lux.network/v1/o11y/nodes/attribute_keys" \
