...
name: team_account
version: "8.0.0"
description: "Read team account: Start a sign-in at lux.id, Complete a sign-in and hand the browser its session, Returns the identity providers this deployment starts a login with.."
---
...
- `GET https://api.lux.network/v1/team/account/auth/{provider}` — Start a sign-in at lux.id
- `GET https://api.lux.network/v1/team/account/auth/{provider}/callback` — Complete a sign-in and hand the browser its session
- `GET https://api.lux.network/v1/team/account/providers` — Returns the identity providers this deployment starts a login with.
...
```bash
curl -sS "https://api.lux.network/v1/team/account/auth/{provider}" \
