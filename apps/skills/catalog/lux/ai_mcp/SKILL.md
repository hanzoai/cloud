...
- `GET https://api.lux.network/v1/ai/mcp/tools` — Tools reports what THIS PROCESS's MCP server carries: how many tools its own registry projects, optionally their names, and which subsystems this process composed.
