...
- `GET https://api.lux.network/v1/channel` — Reports every chat channel this org can send through, and whether it can send through it right now.
...
```bash
curl -sS "https://api.lux.network/v1/channel" \
