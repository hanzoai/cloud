...
name: ai_providers
version: "8.0.0"
description: "Read ai providers: List providers, List providers across tenants, Retrieve a provider."
---
...
- `GET https://api.lux.network/v1/ai/providers` — List providers
- `GET https://api.lux.network/v1/ai/providers/global` — List providers across tenants
- `GET https://api.lux.network/v1/ai/providers/{owner}/{name}` — Retrieve a provider
...
- `/v1/ai/providers` → JSON object.
- `/v1/ai/providers/global` → JSON object.
- `/v1/ai/providers/{owner}/{name}` → JSON object.

## Example

```bash
curl -sS "https://api.lux.network/v1/ai/providers" \
