...
- `GET https://api.lux.network/v1/ci/runs` — Lists recent builds: the repo, the branch, the commit and how each run ended, newest first.
...
```bash
curl -sS "https://api.lux.network/v1/ci/runs" \
