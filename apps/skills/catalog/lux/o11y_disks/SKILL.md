...
- `GET https://api.lux.network/v1/o11y/disks` — Lists the storage disks the datastore reports, with their names and types.
...
```bash
curl -sS "https://api.lux.network/v1/o11y/disks" \
