...
- `GET https://api.lux.network/v1/compliance/accreditation` — Returns the org's tracked accreditation-state records, newest first — evidence entries the org keeps, never a platform certification.
- `GET https://api.lux.network/v1/compliance/accreditation/{id}` — Returns one tracked accreditation record.
...
```bash
curl -sS "https://api.lux.network/v1/compliance/accreditation" \
