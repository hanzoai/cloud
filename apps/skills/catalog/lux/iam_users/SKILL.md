...
- `GET https://api.lux.network/v1/iam/users/get` — Returns one person in your organization, by the organization they belong to and their username.
...
```bash
curl -sS "https://api.lux.network/v1/iam/users" \
