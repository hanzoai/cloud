...
- `GET https://api.lux.network/v1/experiments/{id}/assign` — Is the variant one subject is bucketed into, and the payload that variant carries.
...
```bash
curl -sS "https://api.lux.network/v1/experiments/{id}/assign"
```
