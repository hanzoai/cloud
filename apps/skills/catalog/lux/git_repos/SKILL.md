...
- `GET https://api.lux.network/v1/git/repos/{name}/targets` — Returns a repo's outbound mirror targets — the downstream remotes the mirror reactor pushes to whenever a push lands here.
