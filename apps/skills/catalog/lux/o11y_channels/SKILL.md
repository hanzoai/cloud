...
name: o11y_channels
version: "8.0.0"
description: "Read o11y channels: Lists the org's notification channels., Returns one notification channel, by id.."
---
...
- `GET https://api.lux.network/v1/o11y/channels` — Lists the org's notification channels.
- `GET https://api.lux.network/v1/o11y/channels/{id}` — Returns one notification channel, by id.
...
- `/v1/o11y/channels` → `o11y.O11yChannelsOut` object with fields: `data`, `status`.
- `/v1/o11y/channels/{id}` → `o11y.O11yChannelOut` object with fields: `data`, `status`.

## Example

```bash
curl -sS "https://api.lux.network/v1/o11y/channels" \
