...
- `GET https://api.lux.network/v1/trust/evidence` — Reads the audit rows that stand behind one control, over a window.
...
```bash
curl -sS "https://api.lux.network/v1/trust/evidence" \
