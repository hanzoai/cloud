...
name: books_rules
version: "8.0.0"
description: "Read books rules: Returns the org's auto-categorization rules, highest priority first.."
---
...
- `GET https://api.lux.network/v1/books/rules` — Returns the org's auto-categorization rules, highest priority first.
...
- `/v1/books/rules` → `rulesOut` object with fields: `rules`.

## Example

```bash
curl -sS "https://api.lux.network/v1/books/rules" \
