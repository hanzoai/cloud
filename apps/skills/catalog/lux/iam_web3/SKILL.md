...
name: iam_web3
version: "8.0.0"
description: "Read iam web3: Starts a wallet sign-in: it returns a one-time challenge for the wallet to sign.."
---
...
- `GET https://api.lux.network/v1/iam/web3/nonce` — Starts a wallet sign-in: it returns a one-time challenge for the wallet to sign.

## Response

- `/v1/iam/web3/nonce` → JSON object.

## Example

```bash
curl -sS "https://api.lux.network/v1/iam/web3/nonce" \
