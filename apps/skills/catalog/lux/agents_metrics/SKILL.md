...
- `GET https://api.lux.network/v1/agents/metrics` — Serves the invocations-over-time histogram for the org's Agents dashboard.
...
```bash
curl -sS "https://api.lux.network/v1/agents/metrics" \
