---
name: ai_remote-connections
version: "8.0.0"
description: "Read ai remote connections: List remote-connections, Retrieve a connection."
---

# Lux · AI · remote connections
...
- `GET https://api.lux.network/v1/ai/remote-connections` — List remote-connections
- `GET https://api.lux.network/v1/ai/remote-connections/{owner}/{name}` — Retrieve a connection
...
- `/v1/ai/remote-connections` → JSON object.
- `/v1/ai/remote-connections/{owner}/{name}` → JSON object.

## Example

```bash
curl -sS "https://api.lux.network/v1/ai/remote-connections" \
