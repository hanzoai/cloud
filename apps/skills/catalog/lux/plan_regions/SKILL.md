...
- `GET https://api.lux.network/v1/plan/regions` — Returns the regions cloud capacity is offered in, each with its display name and physical location.
...
```bash
curl -sS "https://api.lux.network/v1/plan/regions" \
