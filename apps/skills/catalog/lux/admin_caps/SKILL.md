...
- `GET https://api.lux.network/v1/admin/caps` — Reads one org's usage caps: its spend alerts plus the derived period spend, over/warn state and reset time.
...
```bash
curl -sS "https://api.lux.network/v1/admin/caps" \
