...
- `GET https://api.lux.network/v1/platform/environments` — Returns your deploy targets, and what is running on each.
...
```bash
curl -sS "https://api.lux.network/v1/platform/environments" \
