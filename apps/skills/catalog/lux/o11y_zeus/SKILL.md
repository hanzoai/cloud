...
name: o11y_zeus
version: "8.0.0"
description: "Read o11y zeus: Returns the deployment's host info from Zeus.."
---
...
- `GET https://api.lux.network/v1/o11y/zeus/hosts` — Returns the deployment's host info from Zeus.

## Response

- `/v1/o11y/zeus/hosts` → `o11y.O11yGettableHostOut` object with fields: `data`, `status`.

## Example

```bash
curl -sS "https://api.lux.network/v1/o11y/zeus/hosts" \
