...
version: "8.0.0"
description: "Read commerce product: List your org's products, as a page, Fetch one product."
---

# Lux · COMMERCE · product
...
- `GET https://api.lux.network/v1/commerce/product/` — List your org's products, as a page
- `GET https://api.lux.network/v1/commerce/product/{productid}` — Fetch one product
...
```bash
curl -sS "https://api.lux.network/v1/commerce/product/" \
