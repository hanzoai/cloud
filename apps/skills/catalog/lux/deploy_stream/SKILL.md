...
- `GET https://api.lux.network/v1/deploy/stream/applications` — Live application fleet updates as Server-Sent Events
- `GET https://api.lux.network/v1/deploy/stream/applications/{name}/resource-tree` — Live resource tree for one application, as Server-Sent Events
...
```bash
curl -sS "https://api.lux.network/v1/deploy/stream/applications" \
