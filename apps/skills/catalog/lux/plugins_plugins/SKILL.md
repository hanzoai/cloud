...
- `GET https://api.lux.network/v1/plugins` — Reports what this deployment actually mounted: every subsystem the composition root declared and whether it is switched on.
...
```bash
curl -sS "https://api.lux.network/v1/plugins" \
