...
name: ai_account
version: "8.0.0"
description: "Read ai account: Account."
---
...
- `GET https://api.lux.network/v1/ai/account` — Account

## Response

- `/v1/ai/account` → `Envelope` object with fields: `data`, `data2`, `msg`, `status`.

## Example

```bash
curl -sS "https://api.lux.network/v1/ai/account" \
