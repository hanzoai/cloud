...
- `GET https://api.lux.network/v1/insights/events` — Returns the caller org's most recent product events, newest first.
...
```bash
curl -sS "https://api.lux.network/v1/insights/events"
```
