...
- `GET https://api.lux.network/v1/platform/releases` — Returns the versions that actually reached the cluster.
...
```bash
curl -sS "https://api.lux.network/v1/platform/releases" \
