...
- `GET https://api.lux.network/v1/experiments` — Every experiment in the caller's org, with its variants, status and decision.
- `GET https://api.lux.network/v1/experiments/{id}` — One experiment's definition and lifecycle: variants, weights, control arm, status and winner.
