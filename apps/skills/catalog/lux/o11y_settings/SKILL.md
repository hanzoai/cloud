...
- `GET https://api.lux.network/v1/o11y/settings/apdex` — Returns apdex settings for the named services.
- `GET https://api.lux.network/v1/o11y/settings/ttl` — Returns the org's current retention policy: default TTL, custom per-label rules, and cold-storage settings where configured.
...
```bash
curl -sS "https://api.lux.network/v1/o11y/settings/apdex" \
