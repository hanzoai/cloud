...
- `GET https://api.lux.network/v1/connectors/{id}/token` — Hands the custodied access token to its owner — the ONE place custody exits.
...
```bash
curl -sS "https://api.lux.network/v1/connectors/{id}/token" \
