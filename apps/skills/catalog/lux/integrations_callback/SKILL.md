---
name: integrations_callback
version: "8.0.0"
description: "Read integrations callback: OAuth return for any connector."
---
...
- `GET https://api.lux.network/v1/integrations/{provider}/callback` — OAuth return for any connector
...
```bash
curl -sS "https://api.lux.network/v1/integrations/{provider}/callback" \
