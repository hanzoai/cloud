...
- `GET https://api.lux.network/v1/o11y/processes/attribute_keys` — Lists the metric attribute keys processes report, for building process filters.
- `GET https://api.lux.network/v1/o11y/processes/attribute_values` — Lists the values one process attribute key has taken, for building process filters.
...
```bash
curl -sS "https://api.lux.network/v1/o11y/processes/attribute_keys" \
