...
- `GET https://api.lux.network/v1/cloudflare/r2/buckets` — Lists the R2 buckets on the org's Cloudflare account.
...
```bash
curl -sS "https://api.lux.network/v1/cloudflare/r2/buckets" \
