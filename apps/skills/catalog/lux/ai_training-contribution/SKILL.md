---
name: ai_training-contribution
version: "8.0.0"
description: "Read ai training contribution: Training Contribution."
---

# Lux · AI · training contribution
...
- `GET https://api.lux.network/v1/ai/training-contribution` — Training Contribution

## Response

- `/v1/ai/training-contribution` → `Envelope` object with fields: `data`, `data2`, `msg`, `status`.

## Example

```bash
curl -sS "https://api.lux.network/v1/ai/training-contribution" \
