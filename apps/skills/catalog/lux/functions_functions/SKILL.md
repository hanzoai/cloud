...
- `GET https://api.lux.network/v1/functions` — Every serverless function the caller's org has published, with its real 7-day rollup
- `GET https://api.lux.network/v1/functions/{name}` — One function in full: spec, trailing-7-day rollup, trigger, latest runs and mounted secret names
