...
- `GET https://api.lux.network/v1/platform/pipelines` — Returns one build-and-deploy pipeline per app, with its latest run.
...
```bash
curl -sS "https://api.lux.network/v1/platform/pipelines" \
