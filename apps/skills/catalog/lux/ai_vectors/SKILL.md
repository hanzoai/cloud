...
name: ai_vectors
version: "8.0.0"
description: "Read ai vectors: List vectors, List vectors across tenants, Retrieve a vector."
---
...
- `GET https://api.lux.network/v1/ai/vectors` — List vectors
- `GET https://api.lux.network/v1/ai/vectors/global` — List vectors across tenants
- `GET https://api.lux.network/v1/ai/vectors/{owner}/{name}` — Retrieve a vector
...
- `/v1/ai/vectors` → JSON object.
- `/v1/ai/vectors/global` → JSON object.
- `/v1/ai/vectors/{owner}/{name}` → JSON object.

## Example

```bash
curl -sS "https://api.lux.network/v1/ai/vectors" \
