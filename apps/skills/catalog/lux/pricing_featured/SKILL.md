...
- `GET https://api.lux.network/v1/pricing/featured` — Returns the models the catalog highlights, filtered to what the caller's org may see.
...
```bash
curl -sS "https://api.lux.network/v1/pricing/featured" \
