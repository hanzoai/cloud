---
name: commerce_disclosure
version: "8.0.0"
description: "Read commerce disclosure: List your org's disclosures, as a page, Fetch one disclosure."
---

# Lux · COMMERCE · disclosure
...
- `GET https://api.lux.network/v1/commerce/disclosure/` — List your org's disclosures, as a page
- `GET https://api.lux.network/v1/commerce/disclosure/{disclosureid}` — Fetch one disclosure

## Parameters

| Name | In | Required | Type | Description |
|---|---|---|---|---|
| `disclosureid` | path | yes | string |  |

## Response

- `/v1/commerce/disclosure/` → JSON object.
- `/v1/commerce/disclosure/{disclosureid}` → JSON object.

## Example

```bash
curl -sS "https://api.lux.network/v1/commerce/disclosure/" \
