---
name: o11y_deployments
version: "8.0.0"
description: "Read o11y deployments: Lists the metric attribute keys Kubernetes deployments report, for building deployment filters., Lists the values one deployment attribute key has taken, for building deployment filters.."
---

# Lux · O11Y · deployments
...
- `GET https://api.lux.network/v1/o11y/deployments/attribute_keys` — Lists the metric attribute keys Kubernetes deployments report, for building deployment filters.
- `GET https://api.lux.network/v1/o11y/deployments/attribute_values` — Lists the values one deployment attribute key has taken, for building deployment filters.
...
- `/v1/o11y/deployments/attribute_keys` → `o11y.O11yInfraAttributeKeysOut` object with fields: `data`, `status`.
- `/v1/o11y/deployments/attribute_values` → `o11y.O11yInfraAttributeValuesOut` object with fields: `data`, `status`.

## Example

```bash
curl -sS "https://api.lux.network/v1/o11y/deployments/attribute_keys" \
