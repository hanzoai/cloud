...
- `GET https://api.lux.network/v1/billing/tier` — Answers which tier the caller is on, what it allows, and what is left to spend.
...
```bash
curl -sS "https://api.lux.network/v1/billing/tier" \
