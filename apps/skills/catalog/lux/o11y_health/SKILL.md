...
name: o11y_health
version: "8.0.0"
description: "Read o11y health: Reports service health.."
---
...
- `GET https://api.lux.network/v1/o11y/health` — Reports service health.

## Parameters

| Name | In | Required | Type | Description |
|---|---|---|---|---|
| `live` | query | no | boolean | Live also checks the datastore connection; an unreachable store refuses with 503. |

## Response

- `/v1/o11y/health` → `o11y.O11yHealthOut` object with fields: `status`.

## Example

```bash
curl -sS "https://api.lux.network/v1/o11y/health" \
