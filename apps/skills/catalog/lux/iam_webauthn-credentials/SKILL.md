...
- `GET https://api.lux.network/v1/iam/webauthn-credentials/{owner}/{name}` — Returns one passkey or security key: whose it is, what device it lives on, and when it was registered.
