...
- `GET https://api.lux.network/v1/finance/usage` — Answers metered spend inside `range=`: the window total, a time series to plot, and one line per usage TAG.
...
```bash
curl -sS "https://api.lux.network/v1/finance/usage"
```
