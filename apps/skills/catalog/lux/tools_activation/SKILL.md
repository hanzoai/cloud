---
name: tools_activation
version: "8.0.0"
description: "Read tools activation: Reports which tools are switched on for the caller's org and project.."
---
...
- `GET https://api.lux.network/v1/tools/activation` — Reports which tools are switched on for the caller's org and project.

## Response

- `/v1/tools/activation` → `activationSet` object with fields: `enabled`.

## Example

```bash
curl -sS "https://api.lux.network/v1/tools/activation" \
