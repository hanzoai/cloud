...
version: "8.0.0"
description: "Read commerce saleschannel: List your org's sales channels, as a page, Fetch one sales channel."
---

# Lux · COMMERCE · saleschannel
...
- `GET https://api.lux.network/v1/commerce/saleschannel/` — List your org's sales channels, as a page
- `GET https://api.lux.network/v1/commerce/saleschannel/{saleschannelid}` — Fetch one sales channel

## Parameters

| Name | In | Required | Type | Description |
|---|---|---|---|---|
| `saleschannelid` | path | yes | string |  |
...
```bash
curl -sS "https://api.lux.network/v1/commerce/saleschannel/" \
