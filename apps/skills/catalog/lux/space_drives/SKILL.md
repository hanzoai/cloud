...
- `GET https://api.lux.network/v1/space/{space}/drives` — Lists a space's drives.
- `GET https://api.lux.network/v1/space/{space}/drives/{drive}/files` — Lists one folder level of a drive.
- `GET https://api.lux.network/v1/space/{space}/drives/{drive}/files/{wildcard1}` — Mints a URL the caller downloads the file from DIRECTLY.
...
```bash
curl -sS "https://api.lux.network/v1/space/{space}/drives" \
