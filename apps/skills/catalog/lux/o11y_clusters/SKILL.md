...
name: o11y_clusters
version: "8.0.0"
description: "Read o11y clusters: Lists the metric attribute keys Kubernetes clusters report, for building cluster filters., Lists the values one cluster attribute key has taken, for building cluster filters.."
---
...
- `GET https://api.lux.network/v1/o11y/clusters/attribute_keys` — Lists the metric attribute keys Kubernetes clusters report, for building cluster filters.
- `GET https://api.lux.network/v1/o11y/clusters/attribute_values` — Lists the values one cluster attribute key has taken, for building cluster filters.
...
- `/v1/o11y/clusters/attribute_keys` → `o11y.O11yInfraAttributeKeysOut` object with fields: `data`, `status`.
- `/v1/o11y/clusters/attribute_values` → `o11y.O11yInfraAttributeValuesOut` object with fields: `data`, `status`.

## Example

```bash
curl -sS "https://api.lux.network/v1/o11y/clusters/attribute_keys" \
