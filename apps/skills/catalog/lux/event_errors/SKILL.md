...
- `GET https://api.lux.network/v1/event/errors` — Errors returns the caller org's most recently captured errors, newest first.
...
```bash
curl -sS "https://api.lux.network/v1/event/errors" \
