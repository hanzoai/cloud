...
version: "8.0.0"
description: "Read billing balance: Prepaid credit the caller's org can still spend."
---
...
- `GET https://api.lux.network/v1/billing/balance` — Prepaid credit the caller's org can still spend
...
```bash
curl -sS "https://api.lux.network/v1/billing/balance" \
