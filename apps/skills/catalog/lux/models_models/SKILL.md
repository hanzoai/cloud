...
name: models_models
version: "8.0.0"
description: "Read models models: Returns the list of available models from the routing table.."
---
...
- `GET https://api.lux.network/v1/models` — Returns the list of available models from the routing table.
