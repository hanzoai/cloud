...
- `GET https://api.lux.network/v1/pricing/free` — Returns the models that cost nothing to call, filtered to what the caller's org may see.
...
```bash
curl -sS "https://api.lux.network/v1/pricing/free" \
