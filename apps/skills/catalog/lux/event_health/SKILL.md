...
- `GET https://api.lux.network/v1/event/health` — Health reports whether the event plane can take a write and the warehouse can answer a read.
...
```bash
curl -sS "https://api.lux.network/v1/event/health" \
