---
name: o11y_errorfromerrorid
version: "8.0.0"
description: "Read o11y errorfromerrorid: Returns one exception instance and the span it happened on, by its error id within a group at a timestamp.."
---

# Lux · O11Y · errorfromerrorid
...
- `GET https://api.lux.network/v1/o11y/errorFromErrorID` — Returns one exception instance and the span it happened on, by its error id within a group at a timestamp.
...
- `/v1/o11y/errorFromErrorID` → `o11y.O11yErrorWithSpan` object with fields: `errorId`, `exceptionEscaped`, `exceptionMessage`, `exceptionStacktrace`, `exceptionType`, `groupID`, `serviceName`, `spanID`, `timestamp`, `traceID`.

## Example

```bash
curl -sS "https://api.lux.network/v1/o11y/errorFromErrorID" \
