...
name: admin_finance
version: "8.0.0"
description: "Read admin finance: Answers GET /v1/admin/finance.."
---
...
- `GET https://api.lux.network/v1/admin/finance` — Answers GET /v1/admin/finance.

## Response

- `/v1/admin/finance` → `FinanceOut` object with fields: `data`, `msg`, `status`.

## Example

```bash
curl -sS "https://api.lux.network/v1/admin/finance" \
