...
- `GET https://api.lux.network/v1/project` — Returns every project your org owns.
- `GET https://api.lux.network/v1/project/{slug}` — Returns one project of yours by slug — its settings, its live URL and the deployment currently serving it.
...
```bash
curl -sS "https://api.lux.network/v1/project" \
