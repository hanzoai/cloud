...
- `GET https://api.lux.network/v1/deploy/callback` — Finish the sign-in round trip and mint the console session
...
```bash
curl -sS "https://api.lux.network/v1/deploy/callback" \
