...
- `GET https://api.lux.network/v1/deploy/version` — Returns the argocd VersionMessage the dashboard SPA reads at bootstrap.
...
```bash
curl -sS "https://api.lux.network/v1/deploy/version" \
