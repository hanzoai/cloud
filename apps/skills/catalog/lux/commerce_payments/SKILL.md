...
- `GET https://api.lux.network/v1/commerce/payments/{id}` — Read one settled payment by its id
...
```bash
curl -sS "https://api.lux.network/v1/commerce/payments/{id}" \
