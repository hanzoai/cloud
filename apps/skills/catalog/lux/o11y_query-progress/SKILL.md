---
name: o11y_query-progress
version: "8.0.0"
description: "Read o11y query progress: Watch one running query's progress."
---

# Lux · O11Y · query progress
...
- `GET https://api.lux.network/v1/o11y/query_progress` — Watch one running query's progress

## Response

- `/v1/o11y/query_progress` → JSON object.

## Example

```bash
curl -sS "https://api.lux.network/v1/o11y/query_progress" \
