...
name: ai_k8s-status
version: "8.0.0"
description: "Read ai k8s status: K8s Status."
---
...
- `GET https://api.lux.network/v1/ai/k8s-status` — K8s Status

## Response

- `/v1/ai/k8s-status` → `Envelope` object with fields: `data`, `data2`, `msg`, `status`.

## Example

```bash
curl -sS "https://api.lux.network/v1/ai/k8s-status" \
