...
name: pricing_iam
version: "8.0.0"
description: "Read pricing iam: ListIAMPlans returns the identity plans — the Lux IAM tiers, each with its monthly and annual price, monthly-active-user allowance and feature list.."
---
...
- `GET https://api.lux.network/v1/pricing/iam` — ListIAMPlans returns the identity plans — the Lux IAM tiers, each with its monthly and annual price, monthly-active-user allowance and feature list.

## Response

- `/v1/pricing/iam` → `pricingPlanList` object with fields: `plans`.

## Example

```bash
curl -sS "https://api.lux.network/v1/pricing/iam" \
