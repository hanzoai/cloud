...
- `GET https://api.lux.network/v1/git/runs` — Returns this org's runs, newest first.
- `GET https://api.lux.network/v1/git/runs/{id}` — Returns one run.
...
```bash
curl -sS "https://api.lux.network/v1/git/runs" \
