...
name: ai_answer
version: "8.0.0"
description: "Read ai answer: Answer."
---
...
- `GET https://api.lux.network/v1/ai/answer` — Answer

## Response

- `/v1/ai/answer` → `Envelope` object with fields: `data`, `data2`, `msg`, `status`.

## Example

```bash
curl -sS "https://api.lux.network/v1/ai/answer" \
