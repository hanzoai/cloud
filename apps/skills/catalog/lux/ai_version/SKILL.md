...
name: ai_version
version: "8.0.0"
description: "Read ai version: Version."
---
...
- `GET https://api.lux.network/v1/ai/version` — Version

## Response

- `/v1/ai/version` → `Envelope` object with fields: `data`, `data2`, `msg`, `status`.

## Example

```bash
curl -sS "https://api.lux.network/v1/ai/version" \
