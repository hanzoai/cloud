...
- `GET https://api.lux.network/v1/ai/nodes` — List nodes
- `GET https://api.lux.network/v1/ai/nodes/{owner}/{name}` — Retrieve a node
- `GET https://api.lux.network/v1/ai/nodes/{owner}/{name}/tunnel` — Tunnel (node)
...
- `/v1/ai/nodes/{owner}/{name}/tunnel` → JSON object.

## Example

```bash
curl -sS "https://api.lux.network/v1/ai/nodes" \
