...
version: "8.0.0"
description: "Read projects releases: Returns a site's releases newest-first, marking the active one — the rollback menu.."
---

# Lux · PROJECTS · releases
...
- `GET https://api.lux.network/v1/projects/{slug}/releases` — Returns a site's releases newest-first, marking the active one — the rollback menu.
...
- `/v1/projects/{slug}/releases` → JSON array of `projectsRelease`.

## Example

```bash
curl -sS "https://api.lux.network/v1/projects/{slug}/releases" \
