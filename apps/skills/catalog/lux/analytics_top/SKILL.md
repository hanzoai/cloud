...
- `GET https://api.lux.network/v1/analytics/top` — Top returns the caller org's ranked lenses for one window, five of them at once.
...
```bash
curl -sS "https://api.lux.network/v1/analytics/top" \
