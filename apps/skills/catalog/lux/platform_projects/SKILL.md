...
- `GET https://api.lux.network/v1/platform/projects` — Returns your org's projects, each with how many apps live under it.
- `GET https://api.lux.network/v1/platform/projects/{project}` — Returns one project and its app count.
- `GET https://api.lux.network/v1/platform/projects/{project}/apps` — Returns the applications in one project, with what the cluster says about them.
- `GET https://api.lux.network/v1/platform/projects/{project}/apps/{app}` — Returns one application, with its live phase, health and secret sync.
- `GET https://api.lux.network/v1/platform/projects/{project}/apps/{app}/deployments` — Returns an app's deployment history.
- `GET https://api.lux.network/v1/platform/projects/{project}/apps/{app}/deployments/{id}` — Returns one deployment of one app.
- `GET https://api.lux.network/v1/platform/projects/{project}/apps/{app}/deployments/{id}/logs` — Returns real logs for a deployment — the build's, then the app's.
- `GET https://api.lux.network/v1/platform/projects/{project}/apps/{app}/domains` — Returns every hostname this app answers on.
...
```bash
curl -sS "https://api.lux.network/v1/platform/projects" \
