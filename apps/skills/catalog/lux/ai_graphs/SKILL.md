...
name: ai_graphs
version: "8.0.0"
description: "Read ai graphs: List graphs, List graphs across tenants, Retrieve a graph."
---
...
- `GET https://api.lux.network/v1/ai/graphs` — List graphs
- `GET https://api.lux.network/v1/ai/graphs/global` — List graphs across tenants
- `GET https://api.lux.network/v1/ai/graphs/{owner}/{name}` — Retrieve a graph
...
- `/v1/ai/graphs` → JSON object.
- `/v1/ai/graphs/global` → JSON object.
- `/v1/ai/graphs/{owner}/{name}` → JSON object.

## Example

```bash
curl -sS "https://api.lux.network/v1/ai/graphs" \
