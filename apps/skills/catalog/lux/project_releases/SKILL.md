...
- `GET https://api.lux.network/v1/project/{slug}/releases` — Returns a site's releases newest-first, marking the active one — the rollback menu.
...
```bash
curl -sS "https://api.lux.network/v1/project/{slug}/releases" \
