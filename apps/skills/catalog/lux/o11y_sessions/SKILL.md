...
- `GET https://api.lux.network/v1/o11y/sessions` — List the caller org's LLM sessions
- `GET https://api.lux.network/v1/o11y/sessions/context` — Tells a sign-in page what an email address can do: which orgs the address belongs to and, per org, which password and SSO routes are open to it.
...
```bash
curl -sS "https://api.lux.network/v1/o11y/sessions" \
