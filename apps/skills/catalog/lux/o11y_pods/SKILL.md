...
name: o11y_pods
version: "8.0.0"
description: "Read o11y pods: Lists the metric attribute keys Kubernetes pods report, for building pod filters., Lists the values one pod attribute key has taken, for building pod filters.."
---
...
- `GET https://api.lux.network/v1/o11y/pods/attribute_keys` — Lists the metric attribute keys Kubernetes pods report, for building pod filters.
- `GET https://api.lux.network/v1/o11y/pods/attribute_values` — Lists the values one pod attribute key has taken, for building pod filters.
...
- `/v1/o11y/pods/attribute_keys` → `o11y.O11yInfraAttributeKeysOut` object with fields: `data`, `status`.
- `/v1/o11y/pods/attribute_values` → `o11y.O11yInfraAttributeValuesOut` object with fields: `data`, `status`.

## Example

```bash
curl -sS "https://api.lux.network/v1/o11y/pods/attribute_keys" \
