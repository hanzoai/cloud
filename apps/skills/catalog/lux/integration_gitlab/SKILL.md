...
- `GET https://api.lux.network/v1/integration/gitlab/projects` — Lists the projects the org's GitLab connection can reach — membership projects, most recently active first.
...
```bash
curl -sS "https://api.lux.network/v1/integration/gitlab/projects" \
