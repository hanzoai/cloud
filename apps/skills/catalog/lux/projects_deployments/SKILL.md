...
- `GET https://api.lux.network/v1/projects/{slug}/deployments` — Returns a project's deploy history, newest version first.
- `GET https://api.lux.network/v1/projects/{slug}/deployments/{id}` — Returns one deployment of a project by id.
...
```bash
curl -sS "https://api.lux.network/v1/projects/{slug}/deployments" \
