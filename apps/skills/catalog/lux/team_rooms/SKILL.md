...
- `GET https://api.lux.network/v1/team/rooms/{id}/messages` — Returns the tail of one room's conversation, oldest first.
...
```bash
curl -sS "https://api.lux.network/v1/team/rooms" \
