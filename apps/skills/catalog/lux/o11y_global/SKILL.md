...
- `GET https://api.lux.network/v1/o11y/global/config` — Returns the deployment's global configuration: its public endpoints and which identity providers are enabled.
...
```bash
curl -sS "https://api.lux.network/v1/o11y/global/config" \
