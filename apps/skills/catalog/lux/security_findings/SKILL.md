...
- `GET https://api.lux.network/v1/security/findings` — The org's findings, across scans or within one
- `GET https://api.lux.network/v1/security/findings/{id}` — One finding
