...
- `GET https://api.lux.network/v1/pricing` — Returns the whole pricing catalog in one document: Zen and third-party models, providers, model families, the free-model list, plan and infrastructure pricing.
...
```bash
curl -sS "https://api.lux.network/v1/pricing" \
