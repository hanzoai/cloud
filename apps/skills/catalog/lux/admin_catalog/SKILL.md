...
- `GET https://api.lux.network/v1/admin/catalog` — Returns the full model and provider catalog annotated with each entry's enablement state, for the operator console.
...
```bash
curl -sS "https://api.lux.network/v1/admin/catalog" \
