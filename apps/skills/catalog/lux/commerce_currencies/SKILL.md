---
name: commerce_currencies
version: "8.0.0"
description: "Read commerce currencies: The reference currency list the price and settings pickers render."
---

# Lux · COMMERCE · currencies
...
- `GET https://api.lux.network/v1/commerce/currencies` — The reference currency list the price and settings pickers render

## Response

- `/v1/commerce/currencies` → JSON object.

## Example

```bash
curl -sS "https://api.lux.network/v1/commerce/currencies" \
