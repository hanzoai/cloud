...
- `GET https://api.lux.network/v1/deploy/health` — Whether this control plane can actually reach the cluster it deploys to
...
```bash
curl -sS "https://api.lux.network/v1/deploy/health" \
