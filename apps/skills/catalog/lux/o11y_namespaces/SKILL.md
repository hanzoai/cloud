...
- `GET https://api.lux.network/v1/o11y/namespaces/attribute_keys` — Lists the metric attribute keys Kubernetes namespaces report, for building namespace filters.
- `GET https://api.lux.network/v1/o11y/namespaces/attribute_values` — Lists the values one namespace attribute key has taken, for building namespace filters.
...
```bash
curl -sS "https://api.lux.network/v1/o11y/namespaces/attribute_keys" \
