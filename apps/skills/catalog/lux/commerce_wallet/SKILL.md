...
- `GET https://api.lux.network/v1/commerce/wallet/` — List your org's wallets, as a page
- `GET https://api.lux.network/v1/commerce/wallet/{walletid}` — Fetch one wallet
...
```bash
curl -sS "https://api.lux.network/v1/commerce/wallet/" \
