...
name: books_gl
version: "8.0.0"
description: "Read books gl: ListGL returns the org's most recent GL Entry rows, newest first.."
---
...
- `GET https://api.lux.network/v1/books/gl` — ListGL returns the org's most recent GL Entry rows, newest first.
...
- `/v1/books/gl` → JSON array of `GLRow`.

## Example

```bash
curl -sS "https://api.lux.network/v1/books/gl" \
