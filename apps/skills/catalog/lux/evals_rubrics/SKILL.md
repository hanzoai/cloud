...
- `GET https://api.lux.network/v1/evals/rubrics` — Is the score shapes your org has declared — each name's data type, its numeric bounds and its allowed categories.
...
```bash
curl -sS "https://api.lux.network/v1/evals/rubrics" \
