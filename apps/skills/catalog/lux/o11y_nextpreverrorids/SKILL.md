...
- `GET https://api.lux.network/v1/o11y/nextPrevErrorIDs` — Returns the ids of the exception instances immediately after and before a given one within its group — the paging cursor the error detail view walks.
...
```bash
curl -sS "https://api.lux.network/v1/o11y/nextPrevErrorIDs" \
