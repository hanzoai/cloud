...
name: o11y_readyz
version: "8.0.0"
description: "Read o11y readyz: Readiness of the observability runtime to serve."
---
...
- `GET https://api.lux.network/v1/o11y/readyz` — Readiness of the observability runtime to serve

## Response

- `/v1/o11y/readyz` → JSON object.

## Example

```bash
curl -sS "https://api.lux.network/v1/o11y/readyz" \
