...
- `GET https://api.lux.network/v1/channel/agent` — Returns which agent answers the caller org's channel: the default and every room bound to another agent.
...
```bash
curl -sS "https://api.lux.network/v1/channel/agent" \
