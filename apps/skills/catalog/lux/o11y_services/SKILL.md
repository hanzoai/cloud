...
name: o11y_services
version: "8.0.0"
description: "Read o11y services: Lists the name of every service the trace store holds, with no window applied — the complete catalog, for pickers and autocomplete.."
---
...
- `GET https://api.lux.network/v1/o11y/services/list` — Lists the name of every service the trace store holds, with no window applied — the complete catalog, for pickers and autocomplete.

## Response

- `/v1/o11y/services/list` → JSON array of `string`.

## Example

```bash
curl -sS "https://api.lux.network/v1/o11y/services/list" \
