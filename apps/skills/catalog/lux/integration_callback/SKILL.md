...
- `GET https://api.lux.network/v1/integration/{provider}/callback` — OAuth return for any connector
...
```bash
curl -sS "https://api.lux.network/v1/integration/{provider}/callback" \
