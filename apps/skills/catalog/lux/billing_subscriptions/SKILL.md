...
- `GET https://api.lux.network/v1/billing/subscriptions` — Lists the plans the caller holds, with the count beside them.
...
```bash
curl -sS "https://api.lux.network/v1/billing/subscriptions" \
