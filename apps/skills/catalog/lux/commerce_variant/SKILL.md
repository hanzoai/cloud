---
name: commerce_variant
version: "8.0.0"
description: "Read commerce variant: List your org's variants, as a page, Fetch one variant."
---

# Lux · COMMERCE · variant
...
- `GET https://api.lux.network/v1/commerce/variant/` — List your org's variants, as a page
- `GET https://api.lux.network/v1/commerce/variant/{variantid}` — Fetch one variant

## Parameters

| Name | In | Required | Type | Description |
|---|---|---|---|---|
| `variantid` | path | yes | string |  |

## Response

- `/v1/commerce/variant/` → JSON object.
- `/v1/commerce/variant/{variantid}` → JSON object.

## Example

```bash
curl -sS "https://api.lux.network/v1/commerce/variant/" \
