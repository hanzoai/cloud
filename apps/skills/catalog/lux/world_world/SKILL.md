...
- `GET https://api.lux.network/v1/world` — Answers GET /v1/world — the product's public endpoint, naming every wire this surface answers on.

## Response

- `/v1/world` → `worldIndex` object with fields: `product`, `summary`, `wires`.

## Example

```bash
curl -sS "https://api.lux.network/v1/world" \
