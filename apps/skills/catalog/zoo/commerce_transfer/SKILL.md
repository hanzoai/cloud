...
- `GET https://api.zoo.ngo/v1/commerce/transfer/` — List your org's transfers, as a page
- `GET https://api.zoo.ngo/v1/commerce/transfer/{transferid}` — Fetch one transfer
...
```bash
curl -sS "https://api.zoo.ngo/v1/commerce/transfer/" \
