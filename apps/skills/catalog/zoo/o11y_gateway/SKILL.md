...
- `GET https://api.zoo.ngo/v1/o11y/gateway/ingestion_keys` — Lists the workspace's ingestion keys, paginated.
- `GET https://api.zoo.ngo/v1/o11y/gateway/ingestion_keys/search` — Lists the workspace's ingestion keys whose name matches the search, paginated.
...
```bash
curl -sS "https://api.zoo.ngo/v1/o11y/gateway/ingestion_keys" \
