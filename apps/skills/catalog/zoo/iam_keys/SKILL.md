...
- `GET https://api.zoo.ngo/v1/iam/keys/get` — Returns one API key: what it is called, what it may reach, and when it was issued.
...
```bash
curl -sS "https://api.zoo.ngo/v1/iam/keys" \
