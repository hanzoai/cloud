...
- `GET https://api.zoo.ngo/v1/o11y/version` — Reports the running build: its version, whether an enterprise edition is present ("N" in this build), and whether first-user setup has completed.
...
```bash
curl -sS "https://api.zoo.ngo/v1/o11y/version" \
