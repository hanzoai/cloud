...
- `GET https://api.zoo.ngo/v1/o11y/statefulsets/attribute_keys` — Lists the metric attribute keys Kubernetes statefulsets report, for building statefulset filters.
- `GET https://api.zoo.ngo/v1/o11y/statefulsets/attribute_values` — Lists the values one statefulset attribute key has taken, for building statefulset filters.
...
```bash
curl -sS "https://api.zoo.ngo/v1/o11y/statefulsets/attribute_keys" \
