...
- `GET https://api.zoo.ngo/v1/o11y/clusters/attribute_keys` — Lists the metric attribute keys Kubernetes clusters report, for building cluster filters.
- `GET https://api.zoo.ngo/v1/o11y/clusters/attribute_values` — Lists the values one cluster attribute key has taken, for building cluster filters.
...
```bash
curl -sS "https://api.zoo.ngo/v1/o11y/clusters/attribute_keys" \
