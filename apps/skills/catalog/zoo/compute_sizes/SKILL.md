...
- `GET https://api.zoo.ngo/v1/compute/sizes` — Sizes lists the machine sizes available to launch, with their specifications.
...
```bash
curl -sS "https://api.zoo.ngo/v1/compute/sizes" \
