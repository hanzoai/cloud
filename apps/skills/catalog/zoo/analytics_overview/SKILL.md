...
- `GET https://api.zoo.ngo/v1/analytics/overview` — Overview returns the caller org's analytics KPIs for one time window.
...
```bash
curl -sS "https://api.zoo.ngo/v1/analytics/overview" \
