...
- `GET https://api.zoo.ngo/v1/o11y/daemonsets/attribute_keys` — Lists the metric attribute keys Kubernetes daemonsets report, for building daemonset filters.
- `GET https://api.zoo.ngo/v1/o11y/daemonsets/attribute_values` — Lists the values one daemonset attribute key has taken, for building daemonset filters.
...
```bash
curl -sS "https://api.zoo.ngo/v1/o11y/daemonsets/attribute_keys" \
