...
- `GET https://api.zoo.ngo/v1/experiments/health` — Is whether the experiments subsystem is mounted and serving in this process.
...
```bash
curl -sS "https://api.zoo.ngo/v1/experiments/health" \
