...
- `GET https://api.zoo.ngo/v1/billing/subscriptions` — Lists the plans the caller holds, with the count beside them.
...
```bash
curl -sS "https://api.zoo.ngo/v1/billing/subscriptions" \
