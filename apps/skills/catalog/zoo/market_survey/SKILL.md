...
- `GET https://api.zoo.ngo/v1/market/survey` — Answers which of the four settlement precompiles carry code on one chain.
...
```bash
curl -sS "https://api.zoo.ngo/v1/market/survey"
```
