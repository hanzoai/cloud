...
- `GET https://api.zoo.ngo/v1/market/chains` — Answers every chain this deployment can read, what is deployed on each, and what its automated market maker amounts to.
...
```bash
curl -sS "https://api.zoo.ngo/v1/market/chains"
```
