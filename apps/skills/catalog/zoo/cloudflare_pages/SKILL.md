...
- `GET https://api.zoo.ngo/v1/cloudflare/pages/projects` — Lists the org's Cloudflare Pages projects.
- `GET https://api.zoo.ngo/v1/cloudflare/pages/projects/{project}` — Reads one Cloudflare Pages project — its build config, deployment configs and latest deployment.
...
```bash
curl -sS "https://api.zoo.ngo/v1/cloudflare/pages/projects" \
