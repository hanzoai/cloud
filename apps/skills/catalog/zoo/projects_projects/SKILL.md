...
- `GET https://api.zoo.ngo/v1/projects` — Returns every project your org owns.
- `GET https://api.zoo.ngo/v1/projects/{slug}` — Returns one project of yours by slug — its settings, its live URL and the deployment currently serving it.
...
```bash
curl -sS "https://api.zoo.ngo/v1/projects" \
