...
- `GET https://api.zoo.ngo/v1/admin/me` — Answers with the validated operator identity — who the console is signed in as, which tier they are, and how wide their tenant window is.
...
```bash
curl -sS "https://api.zoo.ngo/v1/admin/me" \
