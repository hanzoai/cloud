...
- `GET https://api.zoo.ngo/v1/o11y/route_policies` — Lists the org's route policies.
- `GET https://api.zoo.ngo/v1/o11y/route_policies/{id}` — Returns one route policy, by id.
...
```bash
curl -sS "https://api.zoo.ngo/v1/o11y/route_policies" \
