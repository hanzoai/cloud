...
- `GET https://api.zoo.ngo/v1/cloudflare/d1/databases` — Lists the D1 databases on the org's Cloudflare account.
...
```bash
curl -sS "https://api.zoo.ngo/v1/cloudflare/d1/databases" \
