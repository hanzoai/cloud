...
name: deploy_login
version: "8.0.0"
description: "Read deploy login: Start the sign-in round trip for this console."
---
...
- `GET https://api.zoo.ngo/v1/deploy/login` — Start the sign-in round trip for this console
...
```bash
curl -sS "https://api.zoo.ngo/v1/deploy/login" \
