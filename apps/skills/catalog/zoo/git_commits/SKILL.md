...
- `GET https://api.zoo.ngo/git/{org}/{repo}/commits` — Read a repository's commit log
- `GET https://api.zoo.ngo/{org}/{repo}/commits` — Read a repository's commit log
...
```bash
curl -sS "https://api.zoo.ngo/git/{org}/{repo}/commits" \
