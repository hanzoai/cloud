...
- `GET https://api.zoo.ngo/v1/trust` — Reads YOUR organization's whole trust centre, including the addresses of your own gated documents.
...
```bash
curl -sS "https://api.zoo.ngo/v1/trust" \
