...
- `GET https://api.zoo.ngo/v1/admin/providers/credit` — Serves GET /v1/admin/providers/credit — the per-provider upstream credit ledger.
...
```bash
curl -sS "https://api.zoo.ngo/v1/admin/providers/credit" \
