...
- `GET https://api.zoo.ngo/v1/licensing/pubkey` — Pubkey publishes the Ed25519 PUBLIC verification key, at both /pubkey and /jwks.
...
```bash
curl -sS "https://api.zoo.ngo/v1/licensing/pubkey" \
