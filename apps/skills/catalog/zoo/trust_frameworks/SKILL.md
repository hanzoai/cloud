...
- `GET https://api.zoo.ngo/v1/trust/frameworks` — Lists the frameworks coverage is computed against, and how many clauses each publishes.
...
```bash
curl -sS "https://api.zoo.ngo/v1/trust/frameworks" \
