...
- `GET https://api.zoo.ngo/v1/ai/tasks` — List tasks
- `GET https://api.zoo.ngo/v1/ai/tasks/global` — List tasks across tenants
- `GET https://api.zoo.ngo/v1/ai/tasks/{owner}/{name}` — Retrieve a task
...
```bash
curl -sS "https://api.zoo.ngo/v1/ai/tasks" \
