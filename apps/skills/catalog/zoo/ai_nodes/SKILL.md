...
- `GET https://api.zoo.ngo/v1/ai/nodes` — List nodes
- `GET https://api.zoo.ngo/v1/ai/nodes/{owner}/{name}` — Retrieve a node
- `GET https://api.zoo.ngo/v1/ai/nodes/{owner}/{name}/tunnel` — Tunnel (node)
...
```bash
curl -sS "https://api.zoo.ngo/v1/ai/nodes" \
