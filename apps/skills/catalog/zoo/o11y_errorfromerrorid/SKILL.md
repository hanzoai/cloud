...
- `GET https://api.zoo.ngo/v1/o11y/errorFromErrorID` — Returns one exception instance and the span it happened on, by its error id within a group at a timestamp.
...
```bash
curl -sS "https://api.zoo.ngo/v1/o11y/errorFromErrorID" \
