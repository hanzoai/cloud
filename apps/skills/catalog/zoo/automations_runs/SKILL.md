...
- `GET https://api.zoo.ngo/v1/automations/runs` — Returns the caller org's run history, newest first.
- `GET https://api.zoo.ngo/v1/automations/runs/{id}` — Returns one run.
...
```bash
curl -sS "https://api.zoo.ngo/v1/automations/runs"
```
