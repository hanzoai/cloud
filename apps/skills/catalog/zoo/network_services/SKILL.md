...
- `GET https://api.zoo.ngo/v1/network/services` — Returns the Zero Trust edge services the caller's org owns.
...
```bash
curl -sS "https://api.zoo.ngo/v1/network/services" \
