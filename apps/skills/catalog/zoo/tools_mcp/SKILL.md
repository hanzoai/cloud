...
- `GET https://api.zoo.ngo/v1/tools/mcp/servers` — Lists the external MCP servers the caller's org has registered.
...
```bash
curl -sS "https://api.zoo.ngo/v1/tools/mcp/servers" \
