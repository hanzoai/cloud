...
- `GET https://api.zoo.ngo/v1/esign/documents` — Your org's documents, newest first
- `GET https://api.zoo.ngo/v1/esign/documents/{id}` — One document with its recipients and field layout
- `GET https://api.zoo.ngo/v1/esign/documents/{id}/audit` — The document's full audit trail, oldest first
- `GET https://api.zoo.ngo/v1/esign/documents/{id}/download` — Download the document — the sealed PDF once it is complete
