...
- `GET https://api.zoo.ngo/v1/deploy/health` — Health reports whether this deployment can observe the delivery plane.
...
```bash
curl -sS "https://api.zoo.ngo/v1/deploy/health" \
