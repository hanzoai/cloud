...
- `GET https://api.zoo.ngo/v1/ai/vectors` — List vectors
- `GET https://api.zoo.ngo/v1/ai/vectors/global` — List vectors across tenants
- `GET https://api.zoo.ngo/v1/ai/vectors/{owner}/{name}` — Retrieve a vector
...
```bash
curl -sS "https://api.zoo.ngo/v1/ai/vectors" \
