...
- `GET https://api.zoo.ngo/v1/iam/applications/{owner}/{name}` — Returns one application: its sign-in methods, its allowed redirect URIs and the client credentials your integration authenticates with.
