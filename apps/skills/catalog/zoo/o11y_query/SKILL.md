...
- `GET https://api.zoo.ngo/v1/o11y/query` — Evaluates one instant PromQL query against the org's metrics and returns the result at a single point in time.
...
```bash
curl -sS "https://api.zoo.ngo/v1/o11y/query" \
