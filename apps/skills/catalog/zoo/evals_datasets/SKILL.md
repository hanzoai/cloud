...
- `GET https://api.zoo.ngo/v1/evals/datasets` — The datasets your org has
- `GET https://api.zoo.ngo/v1/evals/datasets/{name}` — One dataset, with how many examples it holds
- `GET https://api.zoo.ngo/v1/evals/datasets/{name}/items` — The examples in one of your datasets
