...
- `GET https://api.zoo.ngo/v1/o11y/complete/google` — Complete a Google sign-in
- `GET https://api.zoo.ngo/v1/o11y/complete/oidc` — Complete a generic OIDC sign-in
...
```bash
curl -sS "https://api.zoo.ngo/v1/o11y/complete/google" \
