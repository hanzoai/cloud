...
- `GET https://api.zoo.ngo/v1/commerce/note/` — List your org's notes, as a page
- `GET https://api.zoo.ngo/v1/commerce/note/{noteid}` — Fetch one note
...
```bash
curl -sS "https://api.zoo.ngo/v1/commerce/note/" \
