...
- `GET https://api.zoo.ngo/v1/commerce/store/` — List your org's storefronts as a page
- `GET https://api.zoo.ngo/v1/commerce/store/access` — Whether a store is entitled to trade, and why
- `GET https://api.zoo.ngo/v1/commerce/store/current` — Resolve your org's active storefront without naming an id
- `GET https://api.zoo.ngo/v1/commerce/store/{storeid}` — Fetch one storefront
- `GET https://api.zoo.ngo/v1/commerce/store/{storeid}/bundle/{key}` — Fetch a bundle as this storefront sells it
- `GET https://api.zoo.ngo/v1/commerce/store/{storeid}/listing` — The storefront's whole listing override map
- `GET https://api.zoo.ngo/v1/commerce/store/{storeid}/listing/{key}` — Fetch one listing override, by item id or by its slug or SKU
- `GET https://api.zoo.ngo/v1/commerce/store/{storeid}/product/{key}` — Fetch a product as this storefront sells it
- `GET https://api.zoo.ngo/v1/commerce/store/{storeid}/variant/{key}` — Fetch a variant as this storefront sells it
...
```bash
curl -sS "https://api.zoo.ngo/v1/commerce/store/" \
