...
- `GET https://api.zoo.ngo/v1/o11y/nodes/attribute_keys` — Lists the metric attribute keys Kubernetes nodes report, for building node filters.
- `GET https://api.zoo.ngo/v1/o11y/nodes/attribute_values` — Lists the values one node attribute key has taken, for building node filters.
...
```bash
curl -sS "https://api.zoo.ngo/v1/o11y/nodes/attribute_keys" \
