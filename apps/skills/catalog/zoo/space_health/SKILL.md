...
- `GET https://api.zoo.ngo/v1/space/health` — Health reports whether this deployment can serve spaces, drives and files.
...
```bash
curl -sS "https://api.zoo.ngo/v1/space/health" \
