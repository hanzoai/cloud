...
- `GET https://api.zoo.ngo/v1/commerce/subscriber/` — List your org's subscribers, as a page
- `GET https://api.zoo.ngo/v1/commerce/subscriber/{subscriberid}` — Fetch one subscriber
...
```bash
curl -sS "https://api.zoo.ngo/v1/commerce/subscriber/" \
