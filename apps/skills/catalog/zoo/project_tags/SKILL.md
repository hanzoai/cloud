...
- `GET https://api.zoo.ngo/v1/project/tags` — The site's browser tag set for the hosted tag — which pixels to inject, by publishable key
...
```bash
curl -sS "https://api.zoo.ngo/v1/project/tags" \
