...
- `GET https://api.zoo.ngo/v1/admin/referral/bonuses` — Returns every referral edge in the directory with a fleet summary.
...
```bash
curl -sS "https://api.zoo.ngo/v1/admin/referral/bonuses" \
