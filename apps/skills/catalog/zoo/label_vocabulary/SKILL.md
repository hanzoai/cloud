...
- `GET https://api.zoo.ngo/v1/label/vocabulary` — The closed vocabularies and the precedence rule that resolves a conflict
...
```bash
curl -sS "https://api.zoo.ngo/v1/label/vocabulary" \
