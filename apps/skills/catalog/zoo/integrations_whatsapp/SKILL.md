...
- `GET https://api.zoo.ngo/v1/integrations/whatsapp/webhook` — WhatsApp Cloud API subscription challenge
...
```bash
curl -sS "https://api.zoo.ngo/v1/integrations/whatsapp/webhook" \
