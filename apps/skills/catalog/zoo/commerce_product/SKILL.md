...
- `GET https://api.zoo.ngo/v1/commerce/product/` — List your org's products, as a page
- `GET https://api.zoo.ngo/v1/commerce/product/{productid}` — Fetch one product
...
```bash
curl -sS "https://api.zoo.ngo/v1/commerce/product/" \
