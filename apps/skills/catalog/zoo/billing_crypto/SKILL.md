...
- `GET https://api.zoo.ngo/v1/billing/crypto/deposit/{id}` — Follow one crypto deposit to settlement
- `GET https://api.zoo.ngo/v1/billing/crypto/options` — Which chains and tokens a crypto top-up can use
