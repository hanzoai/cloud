...
- `GET https://api.zoo.ngo/v1/compliance/health` — Health reports subsystem liveness and the wired verification provider.
...
```bash
curl -sS "https://api.zoo.ngo/v1/compliance/health"
```
