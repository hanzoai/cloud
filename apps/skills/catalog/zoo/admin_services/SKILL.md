...
- `GET https://api.zoo.ngo/v1/admin/services` — Reads the launch board: every hosted service in the registry with its LIVE waitlist mode, evaluated through the flag engine.
...
```bash
curl -sS "https://api.zoo.ngo/v1/admin/services" \
