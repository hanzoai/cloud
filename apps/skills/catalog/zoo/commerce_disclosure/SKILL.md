...
- `GET https://api.zoo.ngo/v1/commerce/disclosure/` — List your org's disclosures, as a page
- `GET https://api.zoo.ngo/v1/commerce/disclosure/{disclosureid}` — Fetch one disclosure
...
```bash
curl -sS "https://api.zoo.ngo/v1/commerce/disclosure/" \
