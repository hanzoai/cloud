...
- `GET https://api.zoo.ngo/v1/o11y/query_progress` — Watch one running query's progress
...
```bash
curl -sS "https://api.zoo.ngo/v1/o11y/query_progress" \
