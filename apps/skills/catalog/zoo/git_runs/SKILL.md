...
- `GET https://api.zoo.ngo/v1/git/runs` — Returns this org's runs, newest first.
- `GET https://api.zoo.ngo/v1/git/runs/{id}` — Returns one run.
...
```bash
curl -sS "https://api.zoo.ngo/v1/git/runs" \
