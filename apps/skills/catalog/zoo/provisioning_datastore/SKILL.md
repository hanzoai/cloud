...
version: "8.0.0"
description: "Read provisioning datastore: Lists the caller org's Zoo Datastore warehouses., Returns one Zoo Datastore warehouse's metadata.."
---

# Zoo · PROVISIONING · datastore
...
- `GET https://api.zoo.ngo/v1/provisioning/datastore` — Lists the caller org's Zoo Datastore warehouses.
- `GET https://api.zoo.ngo/v1/provisioning/datastore/{name}` — Returns one Zoo Datastore warehouse's metadata.
...
```bash
curl -sS "https://api.zoo.ngo/v1/provisioning/datastore" \
