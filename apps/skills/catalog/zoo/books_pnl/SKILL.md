...
- `GET https://api.zoo.ngo/v1/books/pnl` — Returns the org's accrual-basis Profit & Loss over an optional (from, to] window of RFC3339 posting times: recognized revenue, matched cost, and the net.
...
```bash
curl -sS "https://api.zoo.ngo/v1/books/pnl" \
