...
- `GET https://api.zoo.ngo/v1/o11y/downtime_schedules` — Lists all planned maintenance windows, optionally narrowed to the active ones or the recurring ones.
- `GET https://api.zoo.ngo/v1/o11y/downtime_schedules/{id}` — Returns one planned maintenance window, by id.
...
```bash
curl -sS "https://api.zoo.ngo/v1/o11y/downtime_schedules" \
