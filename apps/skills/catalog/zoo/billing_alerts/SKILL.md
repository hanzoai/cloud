...
- `GET https://api.zoo.ngo/v1/billing/alerts` — List your org's spend caps and rate limits
- `GET https://api.zoo.ngo/v1/billing/alerts/authorize` — The per-request spend-cap verdict the metering gate consumes
