...
- `GET https://api.zoo.ngo/v1/billing/alerts` — Lists this org's spend caps: the ceiling, its scope, whether it enforces, and how much of it has been spent this period.
- `GET https://api.zoo.ngo/v1/billing/alerts/authorize` — Answers whether one proposed spend fits inside this org's caps.
...
```bash
curl -sS "https://api.zoo.ngo/v1/billing/alerts" \
