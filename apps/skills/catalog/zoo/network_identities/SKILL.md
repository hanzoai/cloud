...
- `GET https://api.zoo.ngo/v1/network/identities` — Returns the fabric identities the caller's org owns.
...
```bash
curl -sS "https://api.zoo.ngo/v1/network/identities" \
