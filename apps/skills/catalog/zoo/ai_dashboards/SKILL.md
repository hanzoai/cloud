...
- `GET https://api.zoo.ngo/v1/ai/dashboards/agents` — Dashboards Agents
- `GET https://api.zoo.ngo/v1/ai/dashboards/vm` — Dashboards Vm
...
```bash
curl -sS "https://api.zoo.ngo/v1/ai/dashboards/agents" \
