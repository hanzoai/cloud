...
- `GET https://api.zoo.ngo/v1/o11y/channels` — Lists the org's notification channels.
- `GET https://api.zoo.ngo/v1/o11y/channels/{id}` — Returns one notification channel, by id.
...
```bash
curl -sS "https://api.zoo.ngo/v1/o11y/channels" \
