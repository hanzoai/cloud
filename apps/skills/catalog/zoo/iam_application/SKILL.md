...
- `GET https://api.zoo.ngo/v1/iam/application` — Returns one application: its sign-in methods, its allowed redirect URIs and the client credentials your integration authenticates with.
...
```bash
curl -sS "https://api.zoo.ngo/v1/iam/application" \
