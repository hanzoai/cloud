...
- `GET https://api.zoo.ngo/v1/security/health` — Reports that the scanning subsystem is serving and how many secret-detection rules the engine holds.
...
```bash
curl -sS "https://api.zoo.ngo/v1/security/health" \
