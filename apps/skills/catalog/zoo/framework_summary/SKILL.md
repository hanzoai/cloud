...
- `GET https://api.zoo.ngo/v1/framework/summary` — Reports how much of the DocType surface the caller's org uses: how many DocTypes it has defined, and how many documents exist across them.
...
```bash
curl -sS "https://api.zoo.ngo/v1/framework/summary" \
