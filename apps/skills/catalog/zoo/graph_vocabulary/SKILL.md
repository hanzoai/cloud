...
- `GET https://api.zoo.ngo/v1/graph/vocabulary` — The relations in use, and the rule that resolves a conflict
...
```bash
curl -sS "https://api.zoo.ngo/v1/graph/vocabulary" \
