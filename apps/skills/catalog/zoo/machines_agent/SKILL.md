...
- `GET https://api.zoo.ngo/v1/machines/{id}/agent` — Returns the agent binding of one of the caller org's machines, or 404 when the machine runs no bot runtime.
...
```bash
curl -sS "https://api.zoo.ngo/v1/machines/{id}/agent" \
