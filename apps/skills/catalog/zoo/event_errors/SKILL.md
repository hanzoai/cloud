...
name: event_errors
version: "8.0.0"
description: "Read event errors: Errors returns the caller org's most recently captured errors, newest first.."
---
...
- `GET https://api.zoo.ngo/v1/event/errors` — Errors returns the caller org's most recently captured errors, newest first.
...
- `/v1/event/errors` → `errorList` object with fields: `data`.

## Example

```bash
curl -sS "https://api.zoo.ngo/v1/event/errors" \
