...
- `GET https://api.zoo.ngo/v1/ai/templates` — List templates
- `GET https://api.zoo.ngo/v1/ai/templates/{owner}/{name}` — Retrieve a template
...
```bash
curl -sS "https://api.zoo.ngo/v1/ai/templates" \
