...
- `GET https://api.zoo.ngo/v1/admin/roles` — Lists IAM roles for one owner org, forwarded VERBATIM from IAM's get-roles.
...
```bash
curl -sS "https://api.zoo.ngo/v1/admin/roles" \
