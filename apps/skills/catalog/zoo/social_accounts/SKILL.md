...
- `GET https://api.zoo.ngo/v1/social/accounts` — List the social accounts connected to your org
- `GET https://api.zoo.ngo/v1/social/accounts/{id}` — Read one connected account
