...
- `GET https://api.zoo.ngo/v1/o11y/dashboards` — Returns a page of v2-shape dashboards for the org.
- `GET https://api.zoo.ngo/v1/o11y/dashboards/{id}` — Returns a v2-shape dashboard.
- `GET https://api.zoo.ngo/v1/o11y/dashboards/{id}/public` — Returns the public-sharing config for a dashboard.
...
```bash
curl -sS "https://api.zoo.ngo/v1/o11y/dashboards" \
