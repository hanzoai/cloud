...
- `GET https://api.zoo.ngo/v1/billing/usage/rollup` — Answers the caller's month: what their plan includes, what has been consumed against it, and the wallet beside it.
