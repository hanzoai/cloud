...
- `GET https://api.zoo.ngo/v1/ai/providers` — List providers
- `GET https://api.zoo.ngo/v1/ai/providers/global` — List providers across tenants
- `GET https://api.zoo.ngo/v1/ai/providers/{owner}/{name}` — Retrieve a provider
...
```bash
curl -sS "https://api.zoo.ngo/v1/ai/providers" \
