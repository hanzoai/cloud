...
- `GET https://api.zoo.ngo/v1/commerce/wallet/` — List your org's wallets, as a page
- `GET https://api.zoo.ngo/v1/commerce/wallet/{walletid}` — Fetch one wallet
...
```bash
curl -sS "https://api.zoo.ngo/v1/commerce/wallet/" \
