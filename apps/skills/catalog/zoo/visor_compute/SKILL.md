...
- `GET https://api.zoo.ngo/v1/visor/compute/regions` — Regions lists the regions a machine can be launched in.
- `GET https://api.zoo.ngo/v1/visor/compute/sizes` — Sizes lists the machine sizes available to launch, with their specifications.
