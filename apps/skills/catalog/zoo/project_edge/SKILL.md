...
- `GET https://api.zoo.ngo/v1/project/edge` — health reports whether a publish reaches readers, rather than whether it was accepted.
...
```bash
curl -sS "https://api.zoo.ngo/v1/project/edge" \
