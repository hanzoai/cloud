...
- `GET https://api.zoo.ngo/v1/team/billing/plan` — Returns the plan and seat counts for the caller's OWN org, resolved from the VERIFIED team session token — never a client header.
- `GET https://api.zoo.ngo/v1/team/billing/ui` — Open the wallet page
- `GET https://api.zoo.ngo/v1/team/billing/ui/{wildcard1}` — Load an asset of the wallet page
...
```bash
curl -sS "https://api.zoo.ngo/v1/team/billing/plan" \
