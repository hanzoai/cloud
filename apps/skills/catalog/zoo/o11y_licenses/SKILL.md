...
- `GET https://api.zoo.ngo/v1/o11y/licenses` — Lists the org's licenses.
- `GET https://api.zoo.ngo/v1/o11y/licenses/active` — Activates the enterprise license.
...
```bash
curl -sS "https://api.zoo.ngo/v1/o11y/licenses" \
