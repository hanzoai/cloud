...
- `GET https://api.zoo.ngo/v1/billing/wire` — Answers where to send a wire top-up: the receiving bank details, with the caller's own payment reference.
...
```bash
curl -sS "https://api.zoo.ngo/v1/billing/wire" \
