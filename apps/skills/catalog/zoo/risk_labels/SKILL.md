...
- `GET https://api.zoo.ngo/v1/risk/labels` — Read the assertions this tenant has recorded
- `GET https://api.zoo.ngo/v1/risk/labels/coverage` — How much of the window has matured, and how much of that is judged
- `GET https://api.zoo.ngo/v1/risk/labels/vocabulary` — The closed vocabularies and the precedence rule that resolves a conflict
...
```bash
curl -sS "https://api.zoo.ngo/v1/risk/labels" \
