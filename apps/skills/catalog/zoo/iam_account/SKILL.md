...
- `GET https://api.zoo.ngo/v1/iam/account` — Returns the signed-in person's own account and the organization they belong to — what a console reads to draw the account menu.
...
```bash
curl -sS "https://api.zoo.ngo/v1/iam/account" \
