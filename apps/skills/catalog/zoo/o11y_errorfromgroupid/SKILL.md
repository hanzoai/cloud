...
- `GET https://api.zoo.ngo/v1/o11y/errorFromGroupID` — Returns the representative exception instance of a group at a timestamp, and the span it happened on.
...
```bash
curl -sS "https://api.zoo.ngo/v1/o11y/errorFromGroupID" \
