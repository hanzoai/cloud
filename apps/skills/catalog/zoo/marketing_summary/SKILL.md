...
- `GET https://api.zoo.ngo/v1/marketing/summary` — Rolls up the caller org's campaigns: how many there are, how many are active, and the summed budget and spend in cents.
...
```bash
curl -sS "https://api.zoo.ngo/v1/marketing/summary" \
