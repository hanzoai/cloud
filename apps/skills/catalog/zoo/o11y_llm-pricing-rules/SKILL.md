...
- `GET https://api.zoo.ngo/v1/o11y/llm_pricing_rules` — Returns the LLM pricing rules for the caller's org, with pagination and an optional search and override filter.
- `GET https://api.zoo.ngo/v1/o11y/llm_pricing_rules/{id}` — Returns a single LLM pricing rule by id.
...
```bash
curl -sS "https://api.zoo.ngo/v1/o11y/llm_pricing_rules" \
