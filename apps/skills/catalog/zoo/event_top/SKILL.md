...
- `GET https://api.zoo.ngo/v1/event/top` — Top returns the caller org's ranked lenses for one window, five of them at once.
...
```bash
curl -sS "https://api.zoo.ngo/v1/event/top" \
