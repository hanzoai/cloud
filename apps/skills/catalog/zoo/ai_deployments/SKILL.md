...
- `GET https://api.zoo.ngo/v1/ai/deployments` — List deployments
- `GET https://api.zoo.ngo/v1/ai/deployments/{owner}/{name}` — Retrieve a application
...
```bash
curl -sS "https://api.zoo.ngo/v1/ai/deployments" \
