...
- `GET https://api.zoo.ngo/v1/iam/linked-accounts` — Returns the sign-in identities linked to the calling person's account — every provider they can currently sign in with.
...
```bash
curl -sS "https://api.zoo.ngo/v1/iam/linked-accounts" \
