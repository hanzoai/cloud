...
- `GET https://api.zoo.ngo/v1/billing/invoices` — List your org's billing invoices
- `GET https://api.zoo.ngo/v1/billing/invoices/{id}` — Read one invoice
- `GET https://api.zoo.ngo/v1/billing/invoices/{id}/pdf` — Download one invoice as a PDF attachment
