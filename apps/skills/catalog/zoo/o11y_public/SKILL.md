...
- `GET https://api.zoo.ngo/v1/o11y/public/dashboards/{id}` — Returns the sanitized dashboard data for public access — the read a shared dashboard's public page makes.
- `GET https://api.zoo.ngo/v1/o11y/public/dashboards/{id}/widgets/{idx}/query_range` — Returns the query-range result for one widget of a public dashboard.
...
```bash
curl -sS "https://api.zoo.ngo/v1/o11y/public/dashboards/{id}" \
