...
- `GET https://api.zoo.ngo/v1/entitlement` — Projection reports which console apps the CALLER's org may open, and the plan slug that decides it.
...
```bash
curl -sS "https://api.zoo.ngo/v1/entitlement" \
