...
- `GET https://api.zoo.ngo/v1/deploy/account/can-i/{wildcard1}` — Compatibility answer the console UI asks before enabling its buttons
...
```bash
curl -sS "https://api.zoo.ngo/v1/deploy/account/can-i/{wildcard1}" \
