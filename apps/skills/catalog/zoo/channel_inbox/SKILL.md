...
- `GET https://api.zoo.ngo/v1/channel/inbox` — Returns the messages people have sent to the caller org's connected chat bots, oldest first, in the portable envelope shape every transport normalises into.
...
```bash
curl -sS "https://api.zoo.ngo/v1/channel/inbox" \
