...
- `GET https://api.zoo.ngo/v1/functions/triggers` — Is what calls the caller org's functions — one row per function.
...
```bash
curl -sS "https://api.zoo.ngo/v1/functions/triggers"
```
