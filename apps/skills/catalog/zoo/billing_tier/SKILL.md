...
- `GET https://api.zoo.ngo/v1/billing/tier` — Answers which tier the caller is on, what it allows, and what is left to spend.
...
```bash
curl -sS "https://api.zoo.ngo/v1/billing/tier" \
