...
- `GET https://api.zoo.ngo/v1/link` — Lists your linked accounts and the devices they sit on.
- `GET https://api.zoo.ngo/v1/link/{id}` — Reads one linked account.
...
```bash
curl -sS "https://api.zoo.ngo/v1/link" \
