...
- `GET https://api.zoo.ngo/v1/todo/board` — Returns a board's issues — work items with their column, priority, assignee, labels and schedule.
...
```bash
curl -sS "https://api.zoo.ngo/v1/todo/board" \
