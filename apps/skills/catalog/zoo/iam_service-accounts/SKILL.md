...
- `GET https://api.zoo.ngo/v1/iam/service-accounts` — Returns your organization's service accounts — what each is called and when it was created.
...
```bash
curl -sS "https://api.zoo.ngo/v1/iam/service-accounts" \
