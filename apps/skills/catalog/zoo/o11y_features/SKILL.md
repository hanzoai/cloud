...
- `GET https://api.zoo.ngo/v1/o11y/features` — Returns the supported feature flags and their resolved values for the caller's org.
...
```bash
curl -sS "https://api.zoo.ngo/v1/o11y/features" \
