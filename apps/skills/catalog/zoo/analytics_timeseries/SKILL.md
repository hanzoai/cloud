...
- `GET https://api.zoo.ngo/v1/analytics/timeseries` — Timeseries returns the caller org's LLM usage over time as an evenly-spaced series.
...
```bash
curl -sS "https://api.zoo.ngo/v1/analytics/timeseries" \
