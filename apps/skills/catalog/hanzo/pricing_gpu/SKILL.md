...
- `GET https://api.hanzo.ai/v1/pricing/gpu` — ListGPUTiers returns the rentable GPU configurations, each with its accelerator count and model, VRAM, vCPU, host memory and hourly price.
...
```bash
curl -sS "https://api.hanzo.ai/v1/pricing/gpu" \
