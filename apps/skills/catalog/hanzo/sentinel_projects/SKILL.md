...
- `GET https://api.hanzo.ai/v1/sentinel/projects` — Lists the caller's org's Sentry projects, each with its freshly-derived DSN.
- `GET https://api.hanzo.ai/v1/sentinel/projects/{id}` — Returns one Sentry project of the caller's org, DSN included.
...
```bash
curl -sS "https://api.hanzo.ai/v1/sentinel/projects" \
