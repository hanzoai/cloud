...
- `GET https://api.hanzo.ai/v1/billing/credits` — Lists the caller's credit grants — every one of them, spent and lapsed and voided included.
...
```bash
curl -sS "https://api.hanzo.ai/v1/billing/credits" \
