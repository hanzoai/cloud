...
- `GET https://api.hanzo.ai/v1/channels/agent` — Returns which agent answers the caller org's channel: the default and every room bound to another agent.
...
```bash
curl -sS "https://api.hanzo.ai/v1/channels/agent" \
