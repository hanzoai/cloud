...
- `GET https://api.hanzo.ai/v1/projects/{slug}/releases` — Returns a site's releases newest-first, marking the active one — the rollback menu.
...
```bash
curl -sS "https://api.hanzo.ai/v1/projects/{slug}/releases" \
