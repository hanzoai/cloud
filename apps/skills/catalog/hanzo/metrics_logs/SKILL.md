...
- `GET https://api.hanzo.ai/v1/metrics/logs/health` — How many log records this deployment holds for your org
- `GET https://api.hanzo.ai/v1/metrics/logs/query` — Search your org's logs by label, time and substring
...
```bash
curl -sS "https://api.hanzo.ai/v1/metrics/logs/health" \
