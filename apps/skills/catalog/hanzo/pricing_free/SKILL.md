...
- `GET https://api.hanzo.ai/v1/pricing/free` — Returns the models that cost nothing to call, filtered to what the caller's org may see.
...
```bash
curl -sS "https://api.hanzo.ai/v1/pricing/free" \
