...
- `GET https://api.hanzo.ai/v1/kms/secrets` — Lists the secrets your org holds, without their values.
- `GET https://api.hanzo.ai/v1/kms/secrets/{wildcard1}` — Reads one secret's value from your org.
...
- You need a different `kms` capability — that product's skills are listed at `https://api.hanzo.ai/.well-known/agent-skills/_kms/index.json`.
