...
- `GET https://api.hanzo.ai/v1/pricing/blockchain` — Returns the blockchain access plans — the RPC and node tiers, each with its monthly price, compute-unit allowance and feature list.
...
```bash
curl -sS "https://api.hanzo.ai/v1/pricing/blockchain" \
