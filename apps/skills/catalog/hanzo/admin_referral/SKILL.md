...
name: admin_referral
version: "8.0.0"
description: "Read admin referral: Returns every referral edge in the directory with a fleet summary.."
---

# Hanzo · ADMIN · referral
...
- `GET https://api.hanzo.ai/v1/admin/referral/bonuses` — Returns every referral edge in the directory with a fleet summary.
...
- `/v1/admin/referral/bonuses` → `adminBonusesEnvelope` object with fields: `data`, `msg`, `status`.

## Example

```bash
curl -sS "https://api.hanzo.ai/v1/admin/referral/bonuses" \
