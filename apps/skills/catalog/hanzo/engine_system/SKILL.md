...
- `GET https://api.hanzo.ai/v1/engine/system` — The serving host's own inventory: devices, memory and build capabilities
...
```bash
curl -sS "https://api.hanzo.ai/v1/engine/system" \
