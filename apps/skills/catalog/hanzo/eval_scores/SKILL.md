...
- `GET https://api.hanzo.ai/v1/eval/scores` — Is the score events your org has recorded, narrowed by any of name, runName and traceId.
...
```bash
curl -sS "https://api.hanzo.ai/v1/eval/scores" \
