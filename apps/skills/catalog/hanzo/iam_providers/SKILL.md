...
- `GET https://api.hanzo.ai/v1/iam/providers` — Returns your organization's providers, newest first — the identity providers your people sign in with, and the senders and connectors your applications go through.
- `GET https://api.hanzo.ai/v1/iam/providers/{owner}/{name}` — Returns one provider: what it connects to and how it is configured.
...
```bash
curl -sS "https://api.hanzo.ai/v1/iam/providers" \
