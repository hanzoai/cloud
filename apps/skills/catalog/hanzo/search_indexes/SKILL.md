...
- `GET https://api.hanzo.ai/v1/search/indexes` — Lists the search indexes with their document counts and timestamps.
...
```bash
curl -sS "https://api.hanzo.ai/v1/search/indexes" \
