...
- `GET https://api.hanzo.ai/v1/admin/promos` — Reads the current platform plan promo — the singleton discount offer, e.g.
...
```bash
curl -sS "https://api.hanzo.ai/v1/admin/promos" \
