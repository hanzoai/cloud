...
- `GET https://api.hanzo.ai/v1/functions/metrics` — Is the org's serverless dashboard over a window: a per-function invocation costLine and how those invocations ended.
...
```bash
curl -sS "https://api.hanzo.ai/v1/functions/metrics" \
