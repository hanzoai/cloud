...
- `GET https://api.hanzo.ai/v1/market/pools` — Answers the automated market makers on one chain: their two tokens, their fee tier, and what has moved through each.
...
```bash
curl -sS "https://api.hanzo.ai/v1/market/pools"
```
