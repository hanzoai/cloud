...
- `GET https://api.hanzo.ai/v1/sbom/health` — Health is a pure liveness probe: the service is up; datastore reflects whether the datastore store is connected.
...
```bash
curl -sS "https://api.hanzo.ai/v1/sbom/health" \
