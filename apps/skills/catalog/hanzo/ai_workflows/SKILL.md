...
- `GET https://api.hanzo.ai/v1/ai/workflows` — List workflows
- `GET https://api.hanzo.ai/v1/ai/workflows/global` — List workflows across tenants
- `GET https://api.hanzo.ai/v1/ai/workflows/{owner}/{name}` — Retrieve a workflow
...
```bash
curl -sS "https://api.hanzo.ai/v1/ai/workflows" \
