...
# Hanzo · AI · training contribution
...
- `GET https://api.hanzo.ai/v1/ai/training-contribution` — Training Contribution
...
```bash
curl -sS "https://api.hanzo.ai/v1/ai/training-contribution" \
