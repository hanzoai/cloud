...
- `GET https://api.hanzo.ai/v1/project` — Returns every project your org owns.
- `GET https://api.hanzo.ai/v1/project/{slug}` — Returns one project of yours by slug — its settings, its live URL and the deployment currently serving it.
...
```bash
curl -sS "https://api.hanzo.ai/v1/project" \
