...
- `GET https://api.hanzo.ai/v1/o11y/licenses` — Lists the org's licenses.
- `GET https://api.hanzo.ai/v1/o11y/licenses/active` — Activates the enterprise license.
...
```bash
curl -sS "https://api.hanzo.ai/v1/o11y/licenses" \
