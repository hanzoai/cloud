...
- `GET https://api.hanzo.ai/v1/commerce/saleschannel/` — List your org's sales channels, as a page
- `GET https://api.hanzo.ai/v1/commerce/saleschannel/{saleschannelid}` — Fetch one sales channel
...
```bash
curl -sS "https://api.hanzo.ai/v1/commerce/saleschannel/" \
