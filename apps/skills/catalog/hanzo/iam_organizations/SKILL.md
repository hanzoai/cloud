...
- `GET https://api.hanzo.ai/v1/iam/organizations` — Returns the organizations you can see, newest first.
- `GET https://api.hanzo.ai/v1/iam/organizations/get` — Returns one organization: its display, its defaults and the sign-in rules everyone in it inherits.
- `GET https://api.hanzo.ai/v1/iam/organizations/search` — Returns the organizations you can act in, the ones you belong to first and the rest after, newest first, narrowed by an optional query against the name or the display name.
