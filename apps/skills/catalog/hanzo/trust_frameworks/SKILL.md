...
- `GET https://api.hanzo.ai/v1/trust/frameworks` — Lists the frameworks coverage is computed against, and how many clauses each publishes.
...
```bash
curl -sS "https://api.hanzo.ai/v1/trust/frameworks" \
