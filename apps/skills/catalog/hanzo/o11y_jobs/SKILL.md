...
- `GET https://api.hanzo.ai/v1/o11y/jobs/attribute_keys` — Lists the metric attribute keys Kubernetes jobs report, for building job filters.
- `GET https://api.hanzo.ai/v1/o11y/jobs/attribute_values` — Lists the values one job attribute key has taken, for building job filters.
...
```bash
curl -sS "https://api.hanzo.ai/v1/o11y/jobs/attribute_keys" \
