...
- `GET https://api.hanzo.ai/v1/o11y/channels` — Lists the org's notification channels.
- `GET https://api.hanzo.ai/v1/o11y/channels/{id}` — Returns one notification channel, by id.
...
```bash
curl -sS "https://api.hanzo.ai/v1/o11y/channels" \
