...
- `GET https://api.hanzo.ai/v1/git/pools` — Returns the capacity this org has declared and how many daemons have entered each pool.
...
```bash
curl -sS "https://api.hanzo.ai/v1/git/pools" \
