...
- `GET https://api.hanzo.ai/v1/commerce/catalog` — The public product catalog projection for a brand
- `GET https://api.hanzo.ai/v1/commerce/catalog/entries` — The raw catalog entries, including the unpublished ones
...
```bash
curl -sS "https://api.hanzo.ai/v1/commerce/catalog" \
