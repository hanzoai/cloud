...
- `GET https://api.hanzo.ai/v1/projects/tags` — The site's browser tag set for the hosted tag — which pixels to inject, by publishable key
...
```bash
curl -sS "https://api.hanzo.ai/v1/projects/tags" \
