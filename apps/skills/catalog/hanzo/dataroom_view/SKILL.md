...
- `GET https://api.hanzo.ai/v1/dataroom/view/{linkId}` — What a share link's visitor sees before authenticating
- `GET https://api.hanzo.ai/v1/dataroom/view/{linkId}/document/{documentId}/file` — Read a document's bytes as an authorised link visitor
...
```bash
curl -sS "https://api.hanzo.ai/v1/dataroom/view/{linkId}"
```
