...
- `GET https://api.hanzo.ai/v1/commerce/stocklocation/` — List your org's stock locations, as a page
- `GET https://api.hanzo.ai/v1/commerce/stocklocation/{stocklocationid}` — Fetch one stock location
...
```bash
curl -sS "https://api.hanzo.ai/v1/commerce/stocklocation/" \
