...
- `GET https://api.hanzo.ai/v1/commerce/webhook/` — List your org's webhooks, as a page
- `GET https://api.hanzo.ai/v1/commerce/webhook/{webhookid}` — Fetch one webhook
...
```bash
curl -sS "https://api.hanzo.ai/v1/commerce/webhook/" \
