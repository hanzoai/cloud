...
- `GET https://api.hanzo.ai/v1/o11y/services/list` — Lists the name of every service the trace store holds, with no window applied — the complete catalog, for pickers and autocomplete.
...
```bash
curl -sS "https://api.hanzo.ai/v1/o11y/services/list" \
