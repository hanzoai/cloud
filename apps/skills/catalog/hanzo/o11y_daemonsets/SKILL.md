---
name: o11y_daemonsets
version: "8.0.0"
description: "Read o11y daemonsets: Lists the metric attribute keys Kubernetes daemonsets report, for building daemonset filters., Lists the values one daemonset attribute key has taken, for building daemonset filters.."
---

# Hanzo · O11Y · daemonsets
...
- `GET https://api.hanzo.ai/v1/o11y/daemonsets/attribute_keys` — Lists the metric attribute keys Kubernetes daemonsets report, for building daemonset filters.
- `GET https://api.hanzo.ai/v1/o11y/daemonsets/attribute_values` — Lists the values one daemonset attribute key has taken, for building daemonset filters.
...
- `/v1/o11y/daemonsets/attribute_keys` → `o11y.O11yInfraAttributeKeysOut` object with fields: `data`, `status`.
- `/v1/o11y/daemonsets/attribute_values` → `o11y.O11yInfraAttributeValuesOut` object with fields: `data`, `status`.

## Example

```bash
curl -sS "https://api.hanzo.ai/v1/o11y/daemonsets/attribute_keys" \
