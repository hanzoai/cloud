...
- `GET https://api.hanzo.ai/v1/plan/dns` — ListDNSPlans returns the DNS plan catalog: the tiers priced on zones, records per zone and queries per day.
...
```bash
curl -sS "https://api.hanzo.ai/v1/plan/dns" \
