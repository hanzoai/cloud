---
name: o11y_namespaces
version: "8.0.0"
description: "Read o11y namespaces: Lists the metric attribute keys Kubernetes namespaces report, for building namespace filters., Lists the values one namespace attribute key has taken, for building namespace filters.."
---

# Hanzo · O11Y · namespaces
...
- `GET https://api.hanzo.ai/v1/o11y/namespaces/attribute_keys` — Lists the metric attribute keys Kubernetes namespaces report, for building namespace filters.
- `GET https://api.hanzo.ai/v1/o11y/namespaces/attribute_values` — Lists the values one namespace attribute key has taken, for building namespace filters.
...
- `/v1/o11y/namespaces/attribute_keys` → `o11y.O11yInfraAttributeKeysOut` object with fields: `data`, `status`.
- `/v1/o11y/namespaces/attribute_values` → `o11y.O11yInfraAttributeValuesOut` object with fields: `data`, `status`.

## Example

```bash
curl -sS "https://api.hanzo.ai/v1/o11y/namespaces/attribute_keys" \
