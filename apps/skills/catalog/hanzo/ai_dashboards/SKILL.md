...
- `GET https://api.hanzo.ai/v1/ai/dashboards/agents` — Dashboards Agents
- `GET https://api.hanzo.ai/v1/ai/dashboards/vm` — Dashboards Vm
...
```bash
curl -sS "https://api.hanzo.ai/v1/ai/dashboards/agents" \
