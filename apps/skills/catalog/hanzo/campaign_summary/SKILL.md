...
- `GET https://api.hanzo.ai/v1/campaign/summary` — Returns the org's go-to-market roll-up: how many campaigns exist, how many are live, their total budget in cents, and which channel executors this deployment can actually reach.
...
```bash
curl -sS "https://api.hanzo.ai/v1/campaign/summary" \
