...
- `GET https://api.hanzo.ai/v1/ai/memory/facts` — List the authenticated user's stored facts
- `GET https://api.hanzo.ai/v1/ai/memory/list` — List the authenticated user's memories, newest first
- `GET https://api.hanzo.ai/v1/ai/memory/recall` — Recall recent/relevant memories for context injection; with q it
- `GET https://api.hanzo.ai/v1/ai/memory/search` — Search the authenticated user's memories (semantic, text fallback)
...
```bash
curl -sS "https://api.hanzo.ai/v1/ai/memory/facts" \
