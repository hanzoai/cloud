...
- `GET https://api.hanzo.ai/v1/platform/fleet` — Returns the platform's own service tier, and where it has drifted.
- `GET https://api.hanzo.ai/v1/platform/fleet/{app}` — Returns one platform service, resolved to production by default.
...
```bash
curl -sS "https://api.hanzo.ai/v1/platform/fleet" \
