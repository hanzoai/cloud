...
name: o11y_processes
version: "8.0.0"
description: "Read o11y processes: Lists the metric attribute keys processes report, for building process filters., Lists the values one process attribute key has taken, for building process filters.."
---

# Hanzo · O11Y · processes
...
- `GET https://api.hanzo.ai/v1/o11y/processes/attribute_keys` — Lists the metric attribute keys processes report, for building process filters.
- `GET https://api.hanzo.ai/v1/o11y/processes/attribute_values` — Lists the values one process attribute key has taken, for building process filters.
...
- `/v1/o11y/processes/attribute_keys` → `o11y.O11yInfraAttributeKeysOut` object with fields: `data`, `status`.
- `/v1/o11y/processes/attribute_values` → `o11y.O11yInfraAttributeValuesOut` object with fields: `data`, `status`.

## Example

```bash
curl -sS "https://api.hanzo.ai/v1/o11y/processes/attribute_keys" \
