...
- `GET https://api.hanzo.ai/v1/billing/invoices` — Lists the caller's invoices, newest first, with the count beside them.
- `GET https://api.hanzo.ai/v1/billing/invoices/{id}` — Read one invoice
- `GET https://api.hanzo.ai/v1/billing/invoices/{id}/pdf` — Download one invoice as a PDF
