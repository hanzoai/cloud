...
- `GET https://api.hanzo.ai/v1/captable/plans` — Returns the caller org's equity plans, newest first.
...
```bash
curl -sS "https://api.hanzo.ai/v1/captable/plans" \
