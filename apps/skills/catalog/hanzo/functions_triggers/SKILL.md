...
- `GET https://api.hanzo.ai/v1/functions/triggers` — Is what calls the caller org's functions — one row per function.
...
```bash
curl -sS "https://api.hanzo.ai/v1/functions/triggers" \
