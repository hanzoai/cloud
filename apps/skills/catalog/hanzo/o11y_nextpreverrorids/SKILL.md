...
- `GET https://api.hanzo.ai/v1/o11y/nextPrevErrorIDs` — Returns the ids of the exception instances immediately after and before a given one within its group — the paging cursor the error detail view walks.
...
```bash
curl -sS "https://api.hanzo.ai/v1/o11y/nextPrevErrorIDs" \
