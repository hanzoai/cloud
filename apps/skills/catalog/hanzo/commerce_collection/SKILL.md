...
- `GET https://api.hanzo.ai/v1/commerce/collection/` — List your org's collections, as a page
- `GET https://api.hanzo.ai/v1/commerce/collection/{collectionid}` — Fetch one collection
...
```bash
curl -sS "https://api.hanzo.ai/v1/commerce/collection/" \
