...
- `GET https://api.hanzo.ai/v1/sites/{slug}/deployments` — Returns a project's deploy history, newest version first.
- `GET https://api.hanzo.ai/v1/sites/{slug}/deployments/{id}` — Returns one deployment of a project by id.
...
```bash
curl -sS "https://api.hanzo.ai/v1/sites/{slug}/deployments"
```
