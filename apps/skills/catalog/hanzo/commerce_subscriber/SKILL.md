...
- `GET https://api.hanzo.ai/v1/commerce/subscriber/` — List your org's subscribers, as a page
- `GET https://api.hanzo.ai/v1/commerce/subscriber/{subscriberid}` — Fetch one subscriber
...
```bash
curl -sS "https://api.hanzo.ai/v1/commerce/subscriber/" \
