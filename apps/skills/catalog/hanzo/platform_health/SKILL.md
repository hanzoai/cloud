...
- `GET https://api.hanzo.ai/v1/platform/health` — Reports whether this control plane can actually deploy anything.
...
```bash
curl -sS "https://api.hanzo.ai/v1/platform/health" \
