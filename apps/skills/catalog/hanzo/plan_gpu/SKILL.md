...
- `GET https://api.hanzo.ai/v1/plan/gpu` — ListGPUTiers returns the rentable GPU configurations, each with its accelerator count and model, VRAM, vCPUs, host memory and hourly price.
...
```bash
curl -sS "https://api.hanzo.ai/v1/plan/gpu" \
