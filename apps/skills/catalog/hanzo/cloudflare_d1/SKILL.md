...
- `GET https://api.hanzo.ai/v1/cloudflare/d1/databases` — Lists the D1 databases on the org's Cloudflare account.
...
```bash
curl -sS "https://api.hanzo.ai/v1/cloudflare/d1/databases" \
...
- You need a different `cloudflare` capability — that product's skills are listed at `https://api.hanzo.ai/.well-known/agent-skills/_cloudflare/index.json`.
