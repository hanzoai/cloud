...
- `GET https://api.hanzo.ai/v1/help/articles` — Returns the public knowledge base: the help center's Published, publicly-visible articles as cards.
- `GET https://api.hanzo.ai/v1/help/articles/{slug}` — Returns one public article by slug, with its body.
...
```bash
curl -sS "https://api.hanzo.ai/v1/help/articles" \
