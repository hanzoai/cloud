...
- `GET https://api.hanzo.ai/v1/functions/{name}/logs` — Is the output of a function's most recent run — its error text when that run failed, else what it printed.
...
```bash
curl -sS "https://api.hanzo.ai/v1/functions/{name}/logs" \
