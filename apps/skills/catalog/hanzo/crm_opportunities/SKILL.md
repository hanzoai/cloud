...
- `GET https://api.hanzo.ai/v1/crm/opportunities` — Returns the caller org's deals, most recently updated first.
- `GET https://api.hanzo.ai/v1/crm/opportunities/{id}` — Returns one of the caller org's deals.
...
```bash
curl -sS "https://api.hanzo.ai/v1/crm/opportunities" \
