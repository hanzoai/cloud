...
- `GET https://api.hanzo.ai/v1/integrations/whatsapp/webhook` — WhatsApp Cloud API subscription challenge
...
```bash
curl -sS "https://api.hanzo.ai/v1/integrations/whatsapp/webhook" \
