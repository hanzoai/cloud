...
name: commerce_movie
version: "8.0.0"
description: "Read commerce movie: List your org's movies, as a page, Fetch one movie."
---

# Hanzo · COMMERCE · movie
...
- `GET https://api.hanzo.ai/v1/commerce/movie/` — List your org's movies, as a page
- `GET https://api.hanzo.ai/v1/commerce/movie/{movieid}` — Fetch one movie

## Parameters

| Name | In | Required | Type | Description |
|---|---|---|---|---|
| `movieid` | path | yes | string |  |
...
```bash
curl -sS "https://api.hanzo.ai/v1/commerce/movie/" \
