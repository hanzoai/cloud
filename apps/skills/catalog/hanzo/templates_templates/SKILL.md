...
- `GET https://api.hanzo.ai/v1/templates` — Lists the public starter-kit catalog plus, for a validated caller, that org's own private kits.
- `GET https://api.hanzo.ai/v1/templates/{slug}` — Returns one starter kit: the caller org's own by that slug, else the public catalog's.
...
```bash
curl -sS "https://api.hanzo.ai/v1/templates" \
