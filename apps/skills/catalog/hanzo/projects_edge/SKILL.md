...
- `GET https://api.hanzo.ai/v1/projects/edge` — health reports whether a publish reaches readers, rather than whether it was accepted.
...
```bash
curl -sS "https://api.hanzo.ai/v1/projects/edge" \
