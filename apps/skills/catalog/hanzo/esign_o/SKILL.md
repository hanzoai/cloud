...
- `GET https://api.hanzo.ai/v1/esign/o/{org}/sign/{token}` — Opens a document you were asked to sign, using your signing link.
...
```bash
curl -sS "https://api.hanzo.ai/v1/esign/o/{org}/sign/{token}" \
...
- You need a different `esign` capability — that product's skills are listed at `https://api.hanzo.ai/.well-known/agent-skills/_esign/index.json`.
