...
- `GET https://api.hanzo.ai/v1/compliance/health` — Health reports subsystem liveness and the wired verification provider.
...
```bash
curl -sS "https://api.hanzo.ai/v1/compliance/health" \
