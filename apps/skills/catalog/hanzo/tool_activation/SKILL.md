...
- `GET https://api.hanzo.ai/v1/tool/activation` — Reports which tools are switched on for the caller's org and project.
...
```bash
curl -sS "https://api.hanzo.ai/v1/tool/activation" \
