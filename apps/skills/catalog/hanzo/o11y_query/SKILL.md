...
- `GET https://api.hanzo.ai/v1/o11y/query` — Evaluates one instant PromQL query against the org's metrics and returns the result at a single point in time.
...
```bash
curl -sS "https://api.hanzo.ai/v1/o11y/query" \
