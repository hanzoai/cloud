...
- `GET https://api.hanzo.ai/v1/books/vendors` — Returns the org's vendor book: each canonical vendor, the alias spellings a receipt may print it under, and the expense account new bills from it default to.
...
```bash
curl -sS "https://api.hanzo.ai/v1/books/vendors" \
