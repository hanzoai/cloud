...
- `GET https://api.hanzo.ai/v1/o11y/alerts` — Returns the org's current alerts.
- `GET https://api.hanzo.ai/v1/o11y/alerts/last` — Replay the alert records this process took
...
```bash
curl -sS "https://api.hanzo.ai/v1/o11y/alerts" \
