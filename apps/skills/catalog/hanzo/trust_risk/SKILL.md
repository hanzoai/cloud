...
- `GET https://api.hanzo.ai/v1/trust/risk` — Reads your risk profile — the label and value pairs describing what your organization handles and how.
...
```bash
curl -sS "https://api.hanzo.ai/v1/trust/risk" \
