...
- `GET https://api.hanzo.ai/v1/commerce/variant/` — List your org's variants, as a page
- `GET https://api.hanzo.ai/v1/commerce/variant/{variantid}` — Fetch one variant
...
```bash
curl -sS "https://api.hanzo.ai/v1/commerce/variant/" \
