...
- `GET https://api.hanzo.ai/v1/visor/compute/regions` — The regions a machine or GPU can be launched into
- `GET https://api.hanzo.ai/v1/visor/compute/sizes` — The machine and GPU sizes that can be launched
