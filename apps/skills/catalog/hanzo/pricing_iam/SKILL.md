...
name: pricing_iam
version: "8.0.0"
description: "Read pricing iam: ListIAMPlans returns the identity plans — the Hanzo IAM tiers, each with its monthly and annual price, monthly-active-user allowance and feature list.."
---
...
- `GET https://api.hanzo.ai/v1/pricing/iam` — ListIAMPlans returns the identity plans — the Hanzo IAM tiers, each with its monthly and annual price, monthly-active-user allowance and feature list.
...
```bash
curl -sS "https://api.hanzo.ai/v1/pricing/iam" \
