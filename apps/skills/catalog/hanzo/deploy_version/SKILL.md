...
- `GET https://api.hanzo.ai/v1/deploy/version` — Returns the argocd VersionMessage the dashboard SPA reads at bootstrap.
...
```bash
curl -sS "https://api.hanzo.ai/v1/deploy/version" \
