...
- `GET https://api.hanzo.ai/v1/risk/policy` — Your organisation's decision-regime history, and which version is in force
...
```bash
curl -sS "https://api.hanzo.ai/v1/risk/policy" \
