...
- `GET https://api.hanzo.ai/v1/research/totals` — Returns the caller org's headline aggregate plus a per-kind breakdown — the observatory's poll target.
...
```bash
curl -sS "https://api.hanzo.ai/v1/research/totals" \
