...
- `GET https://api.hanzo.ai/v1/billing/accounts` — The billing account you are signed in to
- `GET https://api.hanzo.ai/v1/billing/accounts/{id}/members` — Who is on a billing account
