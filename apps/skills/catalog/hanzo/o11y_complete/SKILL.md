...
- `GET https://api.hanzo.ai/v1/o11y/complete/google` — Complete a Google sign-in
- `GET https://api.hanzo.ai/v1/o11y/complete/oidc` — Complete a generic OIDC sign-in
...
```bash
curl -sS "https://api.hanzo.ai/v1/o11y/complete/google" \
