...
- `GET https://api.hanzo.ai/v1/ai/graphs` — List graphs
- `GET https://api.hanzo.ai/v1/ai/graphs/global` — List graphs across tenants
- `GET https://api.hanzo.ai/v1/ai/graphs/{owner}/{name}` — Retrieve a graph
...
```bash
curl -sS "https://api.hanzo.ai/v1/ai/graphs" \
