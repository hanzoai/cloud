...
name: commerce_plans
version: "8.0.0"
description: "Read commerce plans: The raw plan authority rows."
---

# Hanzo · COMMERCE · plans
...
- `GET https://api.hanzo.ai/v1/commerce/plans/entries` — The raw plan authority rows

## Response

- `/v1/commerce/plans/entries` → JSON object.

## Example

```bash
curl -sS "https://api.hanzo.ai/v1/commerce/plans/entries" \
