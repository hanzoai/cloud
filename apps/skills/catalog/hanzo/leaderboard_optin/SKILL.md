...
- `GET https://api.hanzo.ai/v1/leaderboard/optin` — Returns the caller's own public-listing preference and their org's, each with whether the caller may change it.
...
```bash
curl -sS "https://api.hanzo.ai/v1/leaderboard/optin" \
