...
- `GET https://api.hanzo.ai/v1/o11y/pods/attribute_keys` — Lists the metric attribute keys Kubernetes pods report, for building pod filters.
- `GET https://api.hanzo.ai/v1/o11y/pods/attribute_values` — Lists the values one pod attribute key has taken, for building pod filters.
...
```bash
curl -sS "https://api.hanzo.ai/v1/o11y/pods/attribute_keys" \
