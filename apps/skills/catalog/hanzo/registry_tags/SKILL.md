...
- `GET https://api.hanzo.ai/v1/registry/tags` — Tags lists one org-owned repository's tags, read live from the OCI registry.
...
```bash
curl -sS "https://api.hanzo.ai/v1/registry/tags" \
