...
- `GET https://api.hanzo.ai/v1/ai/chats` — List chats
- `GET https://api.hanzo.ai/v1/ai/chats/global` — List chats across tenants
- `GET https://api.hanzo.ai/v1/ai/chats/{owner}/{name}` — Retrieve a chat
