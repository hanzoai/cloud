...
- `GET https://api.hanzo.ai/v1/trust/controls` — Lists every control your organization publishes, with the counts.
- `GET https://api.hanzo.ai/v1/trust/controls/{id}` — Reads one control by id.
...
```bash
curl -sS "https://api.hanzo.ai/v1/trust/controls" \
