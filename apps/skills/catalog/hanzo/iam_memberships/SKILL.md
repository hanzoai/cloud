...
- `GET https://api.hanzo.ai/v1/iam/memberships` — Answers either question about who belongs where: which organizations one person can act in, or who can act in one organization.
...
```bash
curl -sS "https://api.hanzo.ai/v1/iam/memberships" \
