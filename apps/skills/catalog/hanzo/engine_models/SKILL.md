...
- `GET https://api.hanzo.ai/v1/engine/models` — List the models the serving runtime holds, with each one's load state
...
```bash
curl -sS "https://api.hanzo.ai/v1/engine/models" \
