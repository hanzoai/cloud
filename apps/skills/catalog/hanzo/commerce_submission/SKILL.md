...
- `GET https://api.hanzo.ai/v1/commerce/submission/` — List your org's submissions, as a page
- `GET https://api.hanzo.ai/v1/commerce/submission/{submissionid}` — Fetch one submission
...
```bash
curl -sS "https://api.hanzo.ai/v1/commerce/submission/" \
