...
- `GET https://api.hanzo.ai/v1/web3/chains` — Reports the chains this deployment can reach.
- `GET https://api.hanzo.ai/v1/web3/chains/{chain}` — Reports one chain and whether its upstream is answering.
...
```bash
curl -sS "https://api.hanzo.ai/v1/web3/chains" \
