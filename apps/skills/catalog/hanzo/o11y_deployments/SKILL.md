...
- `GET https://api.hanzo.ai/v1/o11y/deployments/attribute_keys` — Lists the metric attribute keys Kubernetes deployments report, for building deployment filters.
- `GET https://api.hanzo.ai/v1/o11y/deployments/attribute_values` — Lists the values one deployment attribute key has taken, for building deployment filters.
...
```bash
curl -sS "https://api.hanzo.ai/v1/o11y/deployments/attribute_keys" \
