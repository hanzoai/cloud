...
- `GET https://api.hanzo.ai/v1/domain/availability` — Checks exact names rather than searching for them, and answers the same quote shape search does — purchasable, premium, first-term and renewal price in cents.
...
```bash
curl -sS "https://api.hanzo.ai/v1/domain/availability" \
