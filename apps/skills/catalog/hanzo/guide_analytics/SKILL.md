...
- `GET https://api.hanzo.ai/v1/guide/analytics` — Analytics returns the caller org's funnel from the analytics lens plus the GTM recommendations derived from it.
...
```bash
curl -sS "https://api.hanzo.ai/v1/guide/analytics" \
