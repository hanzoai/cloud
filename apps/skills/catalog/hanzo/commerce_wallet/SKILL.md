---
name: commerce_wallet
version: "8.0.0"
description: "Read commerce wallet: List your org's wallets, as a page, Fetch one wallet."
---

# Hanzo · COMMERCE · wallet
...
- `GET https://api.hanzo.ai/v1/commerce/wallet/` — List your org's wallets, as a page
- `GET https://api.hanzo.ai/v1/commerce/wallet/{walletid}` — Fetch one wallet

## Parameters

| Name | In | Required | Type | Description |
|---|---|---|---|---|
| `walletid` | path | yes | string |  |

## Response

- `/v1/commerce/wallet/` → JSON object.
- `/v1/commerce/wallet/{walletid}` → JSON object.

## Example

```bash
curl -sS "https://api.hanzo.ai/v1/commerce/wallet/" \
