...
name: links_usage
version: "8.0.0"
description: "Read links usage: Shows one provider account's own usage dashboard., Breaks down what the gateway routed through each of your accounts., Shows plan consumption and Hanzo spend side by side.."
---
...
- `GET https://api.hanzo.ai/v1/links/usage` — Shows one provider account's own usage dashboard.
- `GET https://api.hanzo.ai/v1/links/usage/accounts` — Breaks down what the gateway routed through each of your accounts.
- `GET https://api.hanzo.ai/v1/links/usage/summary` — Shows plan consumption and Hanzo spend side by side.
...
```bash
curl -sS "https://api.hanzo.ai/v1/links/usage" \
