...
- `GET https://api.hanzo.ai/v1/experiments/health` — Is whether the experiments subsystem is mounted and serving in this process.
...
```bash
curl -sS "https://api.hanzo.ai/v1/experiments/health" \
