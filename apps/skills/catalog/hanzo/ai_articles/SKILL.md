...
- `GET https://api.hanzo.ai/v1/ai/articles` — List articles
- `GET https://api.hanzo.ai/v1/ai/articles/global` — List articles across tenants
- `GET https://api.hanzo.ai/v1/ai/articles/{owner}/{name}` — Retrieve a article
...
```bash
curl -sS "https://api.hanzo.ai/v1/ai/articles" \
