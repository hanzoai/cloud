...
- `GET https://api.hanzo.ai/v1/o11y/route_policies` — Lists the org's route policies.
- `GET https://api.hanzo.ai/v1/o11y/route_policies/{id}` — Returns one route policy, by id.
...
```bash
curl -sS "https://api.hanzo.ai/v1/o11y/route_policies" \
