...
- `GET https://api.hanzo.ai/v1/commerce/product/` — List your org's products, as a page
- `GET https://api.hanzo.ai/v1/commerce/product/{productid}` — Fetch one product
...
```bash
curl -sS "https://api.hanzo.ai/v1/commerce/product/" \
