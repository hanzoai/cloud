...
- `GET https://api.hanzo.ai/v1/label/vocabulary` — The closed vocabularies and the precedence rule that resolves a conflict
...
```bash
curl -sS "https://api.hanzo.ai/v1/label/vocabulary" \
