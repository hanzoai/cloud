...
- `GET https://api.hanzo.ai/v1/admin/dataroom/trust` — Roster lists every published trust centre in the deployment with the size of its queue — the platform's view of who is running one and who is leaving people waiting.
...
```bash
curl -sS "https://api.hanzo.ai/v1/admin/dataroom/trust" \
