...
- `GET https://api.hanzo.ai/v1/o11y/span_mapper_groups` — Lists the caller's org's mapping groups, optionally only the enabled ones.
- `GET https://api.hanzo.ai/v1/o11y/span_mapper_groups/{groupId}/span_mappers` — Lists the mappers belonging to one group, in the order they are applied.
...
```bash
curl -sS "https://api.hanzo.ai/v1/o11y/span_mapper_groups" \
