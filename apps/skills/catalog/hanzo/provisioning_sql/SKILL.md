...
version: "8.0.0"
description: "Read provisioning sql: ListSQL lists the caller org's Hanzo SQL databases., GetSQL returns one Hanzo SQL database's metadata.."
---

# Hanzo · PROVISIONING · sql
...
- `GET https://api.hanzo.ai/v1/provisioning/sql` — ListSQL lists the caller org's Hanzo SQL databases.
- `GET https://api.hanzo.ai/v1/provisioning/sql/{name}` — GetSQL returns one Hanzo SQL database's metadata.
...
```bash
curl -sS "https://api.hanzo.ai/v1/provisioning/sql" \
