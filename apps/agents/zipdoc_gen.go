...
func init() {
	...
	zip.Describe("GET /v1/agents", zip.Doc{
		...
		Fields: map[string]string{
			...
			"agentView.emoji":            "Emoji is the glyph drawn in place of a picture, or empty when it has none.",
	...
	zip.Describe("GET /v1/agents/sessions/:id/progress", zip.Doc{
	...
	zip.Describe("PATCH /v1/agents/:ref", zip.Doc{
		...
		Fields: map[string]string{
			...
			"updateAgentIn.emoji":            "Emoji sets the glyph drawn in place of a picture. Sending it clears any image.",
	...
	zip.Describe("POST /agents/roster", zip.Doc{
	...
	zip.Describe("POST /v1/agents", zip.Doc{
		...
		Fields: map[string]string{
			...
			"createAgentIn.emoji":            "Emoji is the glyph drawn in place of a picture, or empty when it has none.",
