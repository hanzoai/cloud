...
func TestWarpcastConnectSealsAndIsolates(t *testing.T) {
	...
	res := cfReq(t, app, http.MethodPost, "/v1/integration/warpcast/connect", "acme", true, map[string]any{"token": warpcastKey})
...
func TestWarpcastRequiresOrgAdmin(t *testing.T) {
	...
	res := cfReq(t, app, http.MethodPost, "/v1/integration/warpcast/connect", "acme", false, map[string]any{"token": warpcastKey})
...
func TestWhatsappConnectSealsWithPhoneID(t *testing.T) {
	...
	res := cfReq(t, app, http.MethodPost, "/v1/integration/whatsapp/connect", "acme", true,
