...
var rawRoutes = map[string]string{
	...
	"GET /v1/integrations/teams/link":             "302",
	"GET /v1/integrations/teams/link/aad":         "302",
	"GET /v1/integrations/teams/link/callback":    "302",
	...
	"POST /v1/integrations/linear/webhook":        "HMAC over the raw body, with the organization's own secret",
