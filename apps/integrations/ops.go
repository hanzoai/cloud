...
//     (what the per-USER /v1/integration/connectors plane keys every row by). channelFacts
...
// /v1/integration, /v1/integration/connectors and the connector webhook, and nothing that
...
type providerRef struct {
	...
	// "cloudflare". Unknown ids are 404, as are the user-plane (/v1/integration/connectors)
...
// the fleet — zip keys a schema on the bare Go type name, and openapi.Compose
...
// body — POST …/pages/builds — made the compose refuse.
