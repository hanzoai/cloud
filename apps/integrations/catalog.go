...
func identifyOIDC(endpoint string) func(context.Context, string) (identity, error) {
...
func identifyGraph(ctx context.Context, token string) (identity, error) {
	...
	return identity{ExternalID: u.ID, Label: u.Name}, nil
}

func identifyTwitch(ctx context.Context, token string) (identity, error) {
	var r struct {
		Data []struct {
			ID    string `json:"id"`
			Login string `json:"login"`
	...
	return identity{ExternalID: r.Data[0].ID, Label: r.Data[0].Login}, nil
}

func identifyReddit(ctx context.Context, token string) (identity, error) {
	var u struct {
		ID   string `json:"id"`
		Name string `json:"name"`
	}
	...
	return identity{ExternalID: u.ID, Label: "u/" + u.Name}, nil
}

func identifyPinterest(ctx context.Context, token string) (identity, error) {
	var u struct {
		Username string `json:"username"`
	}
	...
	return identity{ExternalID: u.Username, Label: u.Username}, nil
}

func identifyMicrosoft(ctx context.Context, token string) (identity, error) {
	var u struct {
		ID   string `json:"id"`
	...
	return identity{ExternalID: u.ID, Label: firstNonEmpty(u.Mail, u.UPN)}, nil
}
