...
func TestPlaneSlackSend_OrgFromCaller(t *testing.T) {
	...
	if _, err := planeSlackSend(ctx, &client.SlackSendIn{Channel: "#ops", Text: "x"}); err != nil {
