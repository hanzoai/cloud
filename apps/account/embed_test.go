...
func TestEmbedStatus_RequiresValidatedPrincipal(t *testing.T) {
	...
	code, _ := callH(t, app, http.MethodGet, "/v1/account/embed?app=cms", nil, "")
...
func TestEmbedStatus_UnknownApp_400(t *testing.T) {
	stubProbe(t, true)
	app := mountBrand(t, "hanzo")
	code, _ := callH(t, app, http.MethodGet, "/v1/account/embed?app=nope",
...
func TestEmbedStatus_BrandMemberEntitled_Reachable(t *testing.T) {
	...
	code, body := callH(t, app, http.MethodGet, "/v1/account/embed?app=cms",
...
func TestEmbedStatus_SuperAdminEntitled(t *testing.T) {
	...
	code, body := callH(t, app, http.MethodGet, "/v1/account/embed?app=erp",
...
func TestEmbedStatus_CustomerOrgNotEntitled_NotProbed(t *testing.T) {
	...
	code, body := callH(t, app, http.MethodGet, "/v1/account/embed?app=help",
