...
func init() {
	zip.Describe("github.com/hanzoai/cloud/apps/account DELETE /v1/account/keys", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/cloud/apps/account GET /avatar/:org/:user/:digest", zip.Doc{
		Description: "Streams a stored photo. No credentials — see the file header.",
	})
	zip.Describe("github.com/hanzoai/cloud/apps/account GET /v1/account/appearance", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/cloud/apps/account GET /v1/account/csrf", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/cloud/apps/account GET /v1/account/embed", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/cloud/apps/account GET /v1/account/keys", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/cloud/apps/account POST /avatar", zip.Doc{
		Description: "Stores the upload and records its URL on the caller's IAM user row.",
	})
	zip.Describe("github.com/hanzoai/cloud/apps/account POST /v1/account/appearance", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/cloud/apps/account POST /v1/account/keys", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/cloud/apps/account POST /v1/account/orgs", zip.Doc{
