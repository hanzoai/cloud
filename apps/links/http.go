...
//
//	POST   /v1/links                          register/upsert a link -> Link
//	GET    /v1/links                          the caller's links + devices -> {links,devices}
//	GET    /v1/links/route                    the redundancy route plan -> RoutePlan
//	GET    /v1/links/devices/:machine         one device: accounts, usage, sessions -> Device
//	POST   /v1/links/devices/:machine/revoke  revoke a device's accounts + sessions
//	GET    /v1/links/:id                      one link -> Link
//	DELETE /v1/links/:id                      revoke a link (log out) + its sessions
//
...
func Mount(app cloud.Router, deps cloud.Deps) error {
	...
	log := luxlog.Default().New("subsystem", "links")
	if deps.DataDir == "" {
