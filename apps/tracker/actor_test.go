...
func TestBoardActor_RefusesAUsernameThatIsSomebodyElsesLogin(t *testing.T) {
	...
	code, raw := asSubject(t, app, http.MethodGet, "/v1/tracker/projects",
	...
	code, raw = asSubject(t, app, http.MethodPost, "/v1/tracker/projects/api/issues",
...
func TestBoardActor_RefusesAnUnverifiedAddress(t *testing.T) {
	...
	code, raw := asUser(t, app, http.MethodGet, "/v1/tracker/projects", "hanzo", "imposter", nil)
	if code != http.StatusForbidden {
...
func TestBoardActor_TheOwnerResolvesAndReads(t *testing.T) {
	...
	code, raw := asUser(t, app, http.MethodGet, "/v1/tracker/projects", "hanzo", "z", nil)
...
func TestBoardActor_RefusesAnUnknownPrincipal(t *testing.T) {
	...
	code, raw := asUser(t, app, http.MethodGet, "/v1/tracker/projects", "hanzo", "ghost", nil)
	if code != http.StatusForbidden {
