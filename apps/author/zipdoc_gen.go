...
func init() {
	zip.Describe("GET /v1/admin/author", zip.Doc{
	...
	zip.Describe("GET /v1/admin/author/:id/basis", zip.Doc{
	...
	zip.Describe("GET /v1/author", zip.Doc{
	...
	zip.Describe("GET /v1/author/basis", zip.Doc{
	...
	zip.Describe("POST /v1/admin/author/:id/approve", zip.Doc{
	...
	zip.Describe("POST /v1/admin/author/:id/payout", zip.Doc{
	...
	zip.Describe("POST /v1/admin/author/:id/suspend", zip.Doc{
	...
	zip.Describe("POST /v1/admin/author/sweep", zip.Doc{
	...
	zip.Describe("POST /v1/author/connect", zip.Doc{
	...
	zip.Describe("POST /v1/author/deploys/record", zip.Doc{
	...
	zip.Describe("POST /v1/author/repos/verify", zip.Doc{
