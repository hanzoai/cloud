...
func init() {
	zip.Describe("GET /v1/admin/referrals/bonuses", zip.Doc{
		...
		Fields: map[string]string{
			...
			"adminReferralView.status":             "Status is the referral's lifecycle state: \"signed_up\", \"qualified\" or\n\"credited\".",
			...
			"adminSummary.signedUp":                "SignedUp is how many are recorded but not yet qualified.",
	...
	zip.Describe("GET /v1/referrals", zip.Doc{
		...
		Fields: map[string]string{
			...
			"myReferralView.status":          "Status is the referral's lifecycle state: \"signed_up\" until the referee\nmakes metered spend, then \"qualified\", then \"credited\".",
			...
			"statusCounts.signedUp":          "SignedUp is how many referees have signed up but not yet spent.",
	...
	zip.Describe("POST /v1/referrals/claim", zip.Doc{
		...
		Fields: map[string]string{
			...
			"claimView.status":    "Status is the referral's lifecycle state: \"signed_up\" until the referee\nmakes metered spend, then \"qualified\", then \"credited\".",
		},
