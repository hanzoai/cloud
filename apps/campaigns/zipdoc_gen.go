...
func init() {
	zip.Describe("DELETE /v1/campaigns/:id", zip.Doc{
	...
	zip.Describe("DELETE /v1/campaigns/:id/channels/:kind", zip.Doc{
	...
	zip.Describe("GET /v1/campaigns", zip.Doc{
	...
	zip.Describe("GET /v1/campaigns/:id", zip.Doc{
	...
	zip.Describe("GET /v1/campaigns/:id/metrics", zip.Doc{
	...
	zip.Describe("GET /v1/campaigns/summary", zip.Doc{
	...
	zip.Describe("POST /v1/campaigns", zip.Doc{
	...
	zip.Describe("POST /v1/campaigns/:id/channels", zip.Doc{
	...
	zip.Describe("POST /v1/campaigns/:id/launch", zip.Doc{
	...
	zip.Describe("POST /v1/campaigns/:id/pause", zip.Doc{
	...
	zip.Describe("PUT /v1/campaigns/:id", zip.Doc{
