...
func init() {
	...
	zip.Describe("GET /v1/admin/providers/credit", zip.Doc{
		Description: "ProvidersCredit reads the per-provider upstream credit ledger. SuperAdmin-guarded\n(see Routes).",
