...
func createDedicated(s *cloud.Service[state], c *zip.Ctx, ctx context.Context, kind, org, name string, e engine, fee int64, instance string) (*provisionResult, error) {
	if s.State.orch == nil {
