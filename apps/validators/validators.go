...
// and because the auto-registered GET /v1/validators/health must stay probe-able.
...
// validatorClaim is the POST /v1/validators body: the slot, the issued nonce, and
...
// validatorList is the GET /v1/validators envelope.
