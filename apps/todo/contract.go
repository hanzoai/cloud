...
// is ONE such primitive — the todo Issue — and no second issues table, no
...
// durable replacement for the hanzo.team Svelte todo.
//
...
// /v1/todo endpoints — never a parallel store:
//
...
// Contact / Opportunity) keep their bespoke stores. They are NOT todo Issues:
...
// the todo, and do not rebuild the todo as a DocType.
//
