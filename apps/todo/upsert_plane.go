...
// and every backfill row was refused with "todo issue sink not registered"
// while this todo was serving its own surface in the next process.
//
...
func planeUpsert(ctx context.Context, in *plane.IssueIn) (*plane.IssueUpserted, error) {
	...
	if mounted == nil {
		return nil, zip.Errorf(503, "todo not mounted")
	}
